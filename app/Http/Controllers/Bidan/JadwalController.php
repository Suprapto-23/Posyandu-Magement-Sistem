...
class JadwalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Kirim notifikasi ke Warga dan Kader
            $this->kirimNotifikasi($request);

            DB::commit();
            return redirect()->route('bidan.jadwal.index')->with('success', 'Jadwal berhasil dibuat dan notifikasi dikirim ke Warga & Kader!');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('bidan.jadwal.index')->with('success', 'Jadwal berhasil diperbarui');
    }

    public function destroy($id)
    {
        JadwalPosyandu::findOrFail($id)->delete();
        return redirect()->route('bidan.jadwal.index')->with('success', 'Jadwal berhasil dihapus');
    }

    // LOGIKA KIRIM NOTIF KE KADER & WARGA
    private function kirimNotifikasi($request)
    {
        ...
        $pesanNotif = "Terdapat kegiatan {$request->kategori} di {$request->lokasi} pada tanggal {$tanggalFormat}.";

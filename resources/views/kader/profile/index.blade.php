...
@section('title', 'Identity Center')
@section('page-name', 'Pusat Identitas')
...
<div class="max-w-[1200px] mx-auto relative pb-10">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 animate-slide-up">
        ...
        <a href="{{ route('kader.profile.password') }}" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white border border-slate-200 text-slate-700 font-bold text-[13px] rounded-xl hover:bg-rose-50 hover:text-rose-600 hover:border-rose-200 transition-all shadow-sm group">
        ...
        <div class="lg:col-span-1 flex flex-col gap-6">
            <div class="glass-card rounded-[32px] p-8 text-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <h3 class="text-xl font-black text-slate-800 font-poppins leading-tight">{{ $user->profile->full_name ?? $user->name }}</h3>
                    ...
                    <div class="flex flex-col gap-3 text-left">
                        <div class="p-3 bg-slate-50 rounded-xl border border-slate-100 flex items-center gap-3">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="text-[12px] font-bold text-slate-700 truncate">{{ $user->email }}</p>
                            </div>
                        </div>
                        <div class="p-3 bg-slate-50 rounded-xl border border-slate-100 flex items-center gap-3">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <p class="text-[12px] font-bold text-slate-700 truncate">{{ $user->created_at->translatedFormat('d F Y') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-8 space-y-6 flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative input-group">
                                ...
                                <input type="text" name="name" value="{{ old('name', $user->profile->full_name ?? $user->name) }}" required class="input-premium">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative input-group">
                                ...
                                <input type="number" name="nik" value="{{ old('nik', $user->profile->nik ?? '') }}" class="input-premium" placeholder="16 Digit NIK">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative input-group">
                                ...
                                <input type="email" name="email" value="{{ old('email', $user->email) }}" required class="input-premium">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative input-group">
                                ...
                                <input type="number" name="telepon" value="{{ old('telepon', $user->profile->telepon ?? '') }}" class="input-premium" placeholder="Contoh: 08123456789">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <div class="relative input-group">
                                ...
                                <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $user->profile->tempat_lahir ?? '') }}" class="input-premium" placeholder="Kota Lahir">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative input-group">
                                ...
                                <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', optional($user->profile->tanggal_lahir)->format('Y-m-d') ?? '') }}" class="input-premium" style="padding-left: 40px; padding-right: 16px;">
                            </div>
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <div class="relative input-group">
                            ...
                            <textarea name="alamat" rows="3" class="input-premium resize-none" placeholder="Tuliskan alamat domisili lengkap...">{{ old('alamat', $user->profile->alamat ?? '') }}</textarea>
                        </div>
                    </div>

...
<style>
    ...
    .swal2-popup { border-radius: 32px !important; padding: 2.5rem 2rem !important; background: rgba(255, 255, 255, 0.98) !important; box-shadow: 0 20px 60px -15px rgba(0,0,0,0.1) !important; }
</style>
@endpush
...
<div id="smoothLoader" class="fixed inset-0 bg-slate-50/90 backdrop-blur-md z-[9999] flex flex-col items-center justify-center transition-all duration-300 opacity-100 pointer-events-auto">
    ...
    <p class="text-emerald-900 font-black tracking-widest text-[11px] animate-pulse uppercase">MENYIAPKAN FORMULIR...</p>
</div>
...
<div class="max-w-6xl mx-auto animate-slide-up relative z-10 pb-12">
    ...
    <div class="text-center mb-10 relative z-10">
        ...
        <p class="text-slate-500 mt-2 font-medium text-[13px] max-w-lg mx-auto">Isi data identitas dan kesehatan dasar peserta Posyandu Lansia. NIK akan digunakan sebagai kunci integrasi akun Warga.</p>
    </div>
            ...
            <div class="lg:col-span-7 glass-panel rounded-[32px] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.04)] p-8 md:p-10 relative overflow-hidden flex flex-col">
                ...
                <div class="space-y-6 flex-1">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_lengkap" value="{{ old('nama_lengkap') }}" required placeholder="Sesuai Kartu Identitas" class="form-input">
                    </div>
                ...
                <div class="bg-white rounded-[32px] border border-slate-200 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.03)] p-8 md:p-10 relative overflow-hidden flex-1 flex flex-col">
                    ...
                    <div class="space-y-6 flex-1">
                        <div>
                            ...
                            <input type="number" name="telepon_keluarga" value="{{ old('telepon_keluarga') }}" required placeholder="Contoh: 0812xxxx" class="form-input focus:ring-4 focus:ring-slate-100">
                        </div>
                        <div>
                            <label class="form-label">Golongan Darah</label>
                            <select name="golongan_darah" class="form-input cursor-pointer shadow-sm">
...
<script>
    ...
    @if(session('error'))
        Swal.fire({
            ...
            customClass: { confirmButton: 'bg-rose-500 text-white px-8 py-3.5 rounded-full font-black text-[11px] uppercase tracking-widest transition-all shadow-md' }
        });
    @endif
</script>
@endpush

...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div>
        ...
        <p class="text-muted mb-0">Pastikan NIK Remaja valid untuk integrasi akun.</p>
    </div>
...
<form action="{{ route('kader.data.remaja.store') }}" method="POST">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm mb-4 rounded-4">
                <div class="card-header bg-white border-bottom-0 pt-4 px-4 pb-0">
                    <h5 class="fw-bold text-primary"><i class="fas fa-user-graduate me-2"></i>Identitas Remaja</h5>
                </div>
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-text small text-primary"><i class="fas fa-info-circle"></i> Digunakan untuk login & integrasi data.</div>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control bg-light border-0" name="alamat" rows="2" required placeholder="Alamat domisili...">{{ old('alamat') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm mb-4 rounded-4 bg-info bg-opacity-10">
                ...
                <div class="card-body p-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control border-0 shadow-sm" name="sekolah" value="{{ old('sekolah') }}" placeholder="Contoh: SMA N 1 Kajen">
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label fw-bold small text-muted">Kelas</label>
                        <input type="text" class="form-control border-0 shadow-sm" name="kelas" value="{{ old('kelas') }}" placeholder="Contoh: X IPA 1">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-white border-0" name="nama_ortu" value="{{ old('nama_ortu') }}" placeholder="Nama Ayah/Ibu">
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold small text-muted">No. HP Orang Tua</label>
                        <input type="number" class="form-control bg-white border-0" name="telepon_ortu" value="{{ old('telepon_ortu') }}" placeholder="08xxxxxxxxxx">
                    </div>

                    <div class="d-grid gap-2 mt-4">
                        <button type="submit" class="btn btn-info text-white rounded-pill py-3 fw-bold shadow">

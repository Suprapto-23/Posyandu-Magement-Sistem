...
<div class="max-w-[1400px] mx-auto animate-slide-up relative z-10 pb-32">
    ...
    <div class="mb-8 flex items-center justify-between gap-4 relative z-10">
        <div class="flex items-center gap-4">
            <a href="{{ route('kader.pemeriksaan.index') }}" class="w-14 h-14 rounded-2xl bg-white border border-slate-200 text-slate-500 flex items-center justify-center hover:bg-indigo-50 hover:text-indigo-600 hover:border-indigo-200 transition-all shadow-sm group shrink-0">
    ...
    <form action="{{ route('kader.pemeriksaan.store') }}" method="POST" id="formPemeriksaan" class="relative z-10">
        @csrf
        {{-- HIDDEN INPUT UNTUK CONTROLLER BACKEND ANDA --}}
        <input type="hidden" name="pasien_type" id="hidden_pasien_type" value="">
        
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
            
            {{-- ========================================================================= --}}
            {{-- KOLOM KIRI: PEMILIHAN PASIEN & WAKTU (PANEL IDENTITAS) --}}
            {{-- ========================================================================= --}}
            <div class="lg:col-span-4 flex flex-col gap-6 h-fit sticky top-6 z-20">
                <div class="bg-white/95 backdrop-blur-2xl border border-white/80 rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 relative overflow-hidden">
                    ...
                    <div class="space-y-6">
                        {{-- Pemilihan Kategori Klaster ILP (Sesuai Kode Asli Anda) --}}
                        <div>
            ...
            {{-- ========================================================================= --}}
            {{-- KOLOM KANAN: WORKSPACE EMR (ELECTRONIC MEDICAL RECORD) KADER --}}
            {{-- ========================================================================= --}}
            <div class="lg:col-span-8 flex flex-col gap-6 z-10">
                
                {{-- BLOK 1: ANTROPOMETRI WAJIB --}}
                ...
                {{-- BLOK 2: TANDA VITAL & PENGUKURAN SPESIFIK KLASTER --}}
                <div class="bg-white rounded-[32px] border border-slate-200 shadow-sm p-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        {{-- Lingkar Lengan (Balita, Bumil, Remaja) --}}
        ...
        {{-- ========================================================================= --}}
        {{-- FLOATING DOCK (ACTION BAR SIMETRIS & ELEGAN DI TENGAH BAWAH LAYAR) --}}
        {{-- ========================================================================= --}}

                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            @if($jadwalBerikutnya)
                                <h4 class="mb-0 fw-bold text-dark">{{ \Carbon\Carbon::parse($jadwalBerikutnya->tanggal)->format('d M Y') }}</h4>
                    ...
                    <div class="mt-3 text-end">
                        <a href="{{ route('bidan.jadwal.index') }}" class="text-decoration-none small fw-bold">Kelola Jadwal <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-white border-0 pt-4 px-4 d-flex justify-content-between align-items-center">
                    ...
                    @if(count($antrianPemeriksaan) > 0)
                        <span class="badge bg-danger pulse-animation">{{ count($antrianPemeriksaan) }} Perlu Dicek</span>
                    @else
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-light text-dark border">{{ ucfirst($item->kategori_pasien) }}</span>
                                    </td>
                                    <td>
                                        <div class="small">
                                            BB: <strong>{{ $item->berat_badan }} kg</strong> | TB: <strong>{{ $item->tinggi_badan }} cm</strong>
                                    ...
                                    <td class="pe-4 text-end">
                                        {{-- Tombol ini harus mengarah ke halaman Edit/Validasi --}}
                                        <a href="{{ route('bidan.pemeriksaan.edit', $item->id) }}" class="btn btn-sm btn-primary rounded-pill px-3">
                        ...
                        <table class="table table-bordered table-sm mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-danger fw-bold">{{ $resiko->diagnosa ?? $resiko->status_gizi }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>

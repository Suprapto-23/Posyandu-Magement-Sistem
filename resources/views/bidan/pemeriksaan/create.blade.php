...
@section('title', 'Pemeriksaan Medis Mandiri')
@section('page-name', 'Input EMR Terpadu')
...
{{-- DATA INJECTION DARI CONTROLLER KE JAVASCRIPT --}}
@php
    $dbPasien = [
...
<div x-data="pemeriksaanApp()" x-init="initData(@js($dbPasien))" class="max-w-5xl mx-auto space-y-6 animate-slide-up pb-10">
    ...
    {{-- FORM UTAMA --}}
    <form id="formPemeriksaan" action="{{ route('bidan.pemeriksaan.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        {{-- ================================================================= --}}
        {{-- LANGKAH 2: CARI PASIEN (CUSTOM DROPDOWN PINTAR)                   --}}
        {{-- ================================================================= --}}
        ...
        {{-- ================================================================= --}}
        {{-- LANGKAH 3: FORM KLINIS (MUNCUL JIKA PASIEN SUDAH DIPILIH)         --}}
        {{-- ================================================================= --}}

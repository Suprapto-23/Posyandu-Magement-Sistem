...
<div class="sidebar" id="sidebar">
    ...
    <nav class="nav flex-column">
        ...
        <a class="nav-link-custom {{ request()->routeIs('bidan.pemeriksaan.verifikasi*') ? 'active' : '' }}" 
           href="{{ route('bidan.dashboard') }}#antrian"
        ...
        <a class="nav-link-custom {{ request()->routeIs('bidan.pemeriksaan.index') ? 'active' : '' }}" 

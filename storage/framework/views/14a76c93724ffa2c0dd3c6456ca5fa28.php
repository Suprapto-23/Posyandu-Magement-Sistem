...
<?php $__env->startSection('title', 'Security Vault'); ?>
<?php $__env->startSection('page-name', 'Keamanan Sandi'); ?>
...
<div class="max-w-[800px] mx-auto relative pb-10">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 animate-slide-up">
        ...
        <a href="<?php echo e(route('kader.profile.index')); ?>" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white border border-slate-200 text-slate-600 font-bold text-[13px] rounded-xl hover:bg-slate-50 transition-all shadow-sm">
    ...
    <div class="glass-card rounded-[32px] overflow-hidden flex flex-col md:flex-row animate-slide-up" style="animation-delay: 0.1s;">
        ...
        <div class="md:w-7/12 flex flex-col bg-white">
            ...
            <form action="<?php echo e(route('kader.profile.update-password')); ?>" method="POST" class="flex flex-col flex-1">
...
<?php echo $__env->make('layouts.kader', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POSYANDU\posyandu-management-system\resources\views/kader/profile/password.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title', 'Command Center Klinis'); ?>
<?php $__env->startSection('page-name', 'Dashboard Klinis'); ?>
    ...
    <div class="bg-white rounded-[32px] p-8 md:p-10 mb-8 border border-slate-200 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.04)] flex flex-col lg:flex-row items-center justify-between gap-8 animate-slide-up relative overflow-hidden">
        ...
        <div class="relative z-10 w-full lg:w-auto flex-1 text-center lg:text-left">
            <h1 class="text-3xl md:text-[38px] font-black text-slate-900 tracking-tight font-poppins mb-2">
                Halo Bidan <span class="text-cyan-600"><?php echo e(Str::words(Auth::user()->name ?? 'Hebat', 1, '')); ?></span> 👋
            </h1>
            ...
            <div class="flex flex-wrap justify-center lg:justify-start items-center gap-3">
                <div class="flex items-center gap-2.5 px-4 py-2.5 rounded-[14px] bg-slate-50 border border-slate-100 text-slate-700 text-[13px] font-bold">
                    <i class="far fa-calendar-alt text-cyan-500"></i> <?php echo e(now()->translatedFormat('l, d F Y')); ?>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 animate-slide-up" style="animation-delay: 0.1s;">
        ...
        <div class="klinik-card p-6 relative overflow-hidden group flex flex-col justify-between border-rose-200/60 bg-rose-50/30">
            <div class="flex justify-between items-start mb-5">
                <div class="w-12 h-12 rounded-xl bg-rose-100 text-rose-600 flex items-center justify-center text-xl border border-rose-200 shrink-0 <?php echo e($stats['menunggu_validasi'] > 0 ? 'pulse-alert' : ''); ?>">
                    <i class="fas fa-procedures"></i>
                </div>
                <?php if($stats['menunggu_validasi'] > 0): ?>
            ...
            <div>
                <h3 class="text-4xl font-black text-rose-600 font-poppins leading-none mb-1.5"><?php echo e($stats['menunggu_validasi']); ?></h3>
        ...
        <div class="klinik-card p-6 relative flex flex-col justify-between">
            ...
            <div>
                <h3 class="text-4xl font-black text-slate-800 font-poppins leading-none mb-1.5"><?php echo e($stats['selesai_divalidasi']); ?></h3>
        ...
        <div class="klinik-card p-6 relative flex flex-col justify-between">
            ...
            <div>
                <h3 class="text-4xl font-black text-slate-800 font-poppins leading-none mb-1.5"><?php echo e($stats['total_pasien']); ?></h3>
        ...
        <div class="klinik-card p-6 relative flex flex-col justify-between">
            ...
            <div>
                <h3 class="text-4xl font-black text-slate-800 font-poppins leading-none mb-1.5"><?php echo e($stats['jadwal_hari_ini']); ?></h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-8 animate-slide-up" style="animation-delay: 0.2s;">
        ...
        <div class="lg:col-span-2 klinik-card p-6 sm:p-8 flex flex-col">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('bidan.pemeriksaan.index')); ?>" class="px-4 py-2 bg-cyan-50 hover:bg-cyan-100 text-cyan-700 text-[11px] font-black uppercase tracking-widest rounded-xl transition-colors">Lihat Semua</a>
            </div>
            ...
            <div class="flex-1 overflow-x-auto custom-scrollbar">
                <table class="w-full text-left border-collapse min-w-[500px]">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <?php $__empty_1 = true; $__currentLoopData = $antrianLive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $antri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50 transition-colors">
                            <td class="py-3 px-4">
                                <?php
                                    $nama = $antri->balita->nama_lengkap ?? $antri->remaja->nama_lengkap ?? $antri->lansia->nama_lengkap ?? 'Ibu Hamil';
                                ?>
                                <p class="text-[13px] font-bold text-slate-800 truncate max-w-[150px]"><?php echo e($nama); ?></p>
                                <span class="text-[10px] font-black text-cyan-600 uppercase tracking-wider"><?php echo e($antri->kategori_pasien); ?></span>
                            </td>
                            <td class="py-3 px-4">
                                <span class="inline-block px-2 py-1 bg-white border border-slate-200 text-slate-600 text-[11px] font-bold rounded-md shadow-sm">
                                    BB: <?php echo e($antri->berat_badan ?? '-'); ?>kg | TB: <?php echo e($antri->tinggi_badan ?? '-'); ?>cm
                                </span>
                            </td>
                            <td class="py-3 px-4 text-[12px] font-medium text-slate-500">
                                <?php echo e($antri->created_at->diffForHumans()); ?>
            ...
            <div class="klinik-card p-6 border-l-4 border-l-amber-400 bg-amber-50/30">
                ...
                <div class="space-y-3">
                    <div class="bg-white p-3 rounded-xl border border-slate-100 flex items-center justify-between shadow-sm">
                        ...
                        <span class="text-[16px] font-black text-rose-600"><?php echo e($alertRisiko['balita_stunting']); ?></span>
                    </div>
                    <div class="bg-white p-3 rounded-xl border border-slate-100 flex items-center justify-between shadow-sm">
                        <div class="flex items-center gap-3">
                        ...
                        <span class="text-[16px] font-black text-sky-600"><?php echo e($alertRisiko['lansia_hipertensi']); ?></span>
                    </div>
                </div>
            </div>

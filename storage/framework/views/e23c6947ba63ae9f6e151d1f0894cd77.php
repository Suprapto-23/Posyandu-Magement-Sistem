...
<?php $__env->startSection('title', 'Dashboard Klinis'); ?>
        ...
        <div class="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            <div class="flex-1 text-center lg:text-left w-full">
                ...
                <h1 class="text-3xl md:text-5xl lg:text-[54px] font-black text-white tracking-tight font-poppins mb-4 leading-tight">
                    <?php echo e($sapaan); ?>, <?php echo e($namaDepan); ?>! 👩‍⚕️
                </h1>
                ...
                <div class="flex flex-wrap items-center justify-center lg:justify-start gap-3">
                    <div class="px-4 py-2.5 bg-rose-500/20 backdrop-blur-md border border-rose-500/40 rounded-full flex items-center gap-2">
                        ...
                        <span class="text-white text-[12px] font-bold"><?php echo e($stats['menunggu_validasi'] ?? 0); ?> Antrian Menunggu</span>
                    </div>
                    <div class="px-4 py-2.5 bg-white/10 backdrop-blur-md border border-white/20 rounded-full flex items-center gap-2">
                        ...
                        <span class="text-white text-[12px] font-bold"><?php echo e($stats['selesai_divalidasi'] ?? 0); ?> Validasi Selesai</span>
                    </div>
                </div>
            </div>
            ...
            <div class="shrink-0 w-full sm:w-auto mt-4 lg:mt-0">
                <a href="<?php echo e(route('bidan.pemeriksaan.index')); ?>" class="w-full inline-flex items-center justify-center gap-3 px-10 py-5 bg-white text-cyan-700 font-black text-[13px] uppercase tracking-widest rounded-2xl hover:bg-cyan-50 hover:scale-105 transition-all duration-300 shadow-[0_10px_25px_rgba(0,0,0,0.2)] group">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 relative z-10 fade-in-up delay-1">
        ...
        <div class="nexus-glass-card p-5 md:p-6 flex flex-col justify-between group overflow-hidden relative min-h-[140px] bg-gradient-to-br from-rose-50 to-white border-rose-100">
            ...
            <div class="relative z-10">
                <h3 class="text-3xl font-black text-slate-800 font-poppins leading-none"><?php echo e(number_format($stats['menunggu_validasi'] ?? 0)); ?></h3>
        ...
        <div class="nexus-glass-card p-5 md:p-6 flex flex-col justify-between group overflow-hidden relative min-h-[140px]">
            ...
            <div class="relative z-10">
                <h3 class="text-3xl font-black text-slate-800 font-poppins leading-none"><?php echo e(number_format($stats['selesai_divalidasi'] ?? 0)); ?></h3>
        ...
        <div class="nexus-glass-card p-5 md:p-6 flex flex-col justify-between group overflow-hidden relative min-h-[140px]">
            <div class="flex justify-between items-start mb-2 relative z-10">
                <div class="w-12 h-12 rounded-[14px] bg-<?php echo e($risikoColor); ?>-50 text-<?php echo e($risikoColor); ?>-500 flex items-center justify-center text-xl border border-<?php echo e($risikoColor); ?>-100 group-hover:scale-110 transition-transform shadow-sm shrink-0"><i class="fas fa-exclamation-triangle"></i></div>
            </div>
            <div class="relative z-10">
                <h3 class="text-3xl font-black text-slate-800 font-poppins leading-none"><?php echo e(number_format($totalRisiko)); ?></h3>
                <p class="text-[10px] font-black text-<?php echo e($risikoColor); ?>-500 uppercase tracking-widest mt-1.5">Peringatan Medis</p>
            </div>
        </div>
        ...
        <div class="nexus-glass-card p-5 md:p-6 flex flex-col justify-between group overflow-hidden relative min-h-[140px] bg-gradient-to-br from-slate-800 to-slate-900 border-slate-700 text-white">
            ...
            <div class="relative z-10">
                <h3 class="text-3xl font-black text-white font-poppins leading-none"><?php echo e(number_format($stats['jadwal_hari_ini'] ?? 0)); ?></h3>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-6 relative z-10 fade-in-up delay-2">
        ...
        <div class="xl:col-span-7 nexus-glass-card overflow-hidden flex flex-col min-h-[400px]">
            <div class="px-6 md:px-8 py-5 border-b border-slate-100 bg-white/50 flex justify-between items-center">
                ...
                <a href="<?php echo e(route('bidan.pemeriksaan.index')); ?>" class="text-[11px] font-black text-cyan-600 hover:text-cyan-800 tracking-widest uppercase flex items-center gap-1">Lihat Semua <i class="fas fa-arrow-right"></i></a>
            </div>
            
            <div class="p-4 md:p-6 flex-1 overflow-y-auto micro-scroll bg-slate-50/30 max-h-[350px]">
                <?php if(isset($antrianLive) && $antrianLive->count() > 0): ?>
                    <div class="space-y-3">
                        <?php $__currentLoopData = $antrianLive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $antrian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php 
                            ...
                            <div class="p-4 bg-white border border-slate-200 rounded-[20px] hover:border-cyan-300 hover:shadow-lg transition-all group flex flex-col sm:flex-row sm:items-center gap-4">
                                <div class="w-12 h-12 rounded-[14px] bg-slate-100 text-slate-500 flex items-center justify-center shrink-0 font-black font-poppins text-lg group-hover:bg-cyan-50 group-hover:text-cyan-600 transition-colors">
                                    <?php echo e(substr($namaPasien, 0, 1)); ?>

                                </div>
                                <div class="flex-1 min-w-0">
                                    <h4 class="text-[14px] font-black text-slate-800 font-poppins truncate group-hover:text-cyan-700 transition-colors"><?php echo e($namaPasien); ?></h4>
                                    <div class="flex items-center gap-2 mt-1.5">
                                        <span class="px-2 py-0.5 text-[9px] font-black border rounded-md <?php echo e($warnaKat); ?>"><?php echo e($kategori); ?></span>
                                        <span class="text-[10px] font-medium text-slate-400"><i class="far fa-clock mr-1"></i><?php echo e($antrian->created_at->diffForHumans()); ?></span>
                                    </div>
                                </div>
                                <a href="<?php echo e(route('bidan.pemeriksaan.validasi', $antrian->id)); ?>" class="w-full sm:w-auto px-6 py-3 bg-white border border-cyan-200 text-cyan-600 font-black text-[10px] uppercase tracking-widest rounded-xl hover:bg-cyan-500 hover:text-white hover:border-cyan-500 transition-all text-center shrink-0 shadow-sm">
                                    Validasi Data
                                </a>
                            </div>
            ...
            <div class="nexus-glass-card overflow-hidden flex flex-col flex-1">
                ...
                <div class="p-6 flex flex-col sm:flex-row items-center justify-center gap-6 md:gap-8 bg-white/30 flex-1">
                    ...
                    <div class="flex flex-col gap-2.5 w-full sm:w-auto">
                        <div class="flex justify-between items-center gap-4 text-[11px] font-bold"><span class="text-rose-500"><i class="fas fa-circle text-[8px] mr-1.5"></i>Balita</span> <span class="text-slate-800"><?php echo e($demografi['balita'] ?? 0); ?></span></div>
                        <div class="flex justify-between items-center gap-4 text-[11px] font-bold"><span class="text-pink-500"><i class="fas fa-circle text-[8px] mr-1.5"></i>Ibu Hamil</span> <span class="text-slate-800"><?php echo e($demografi['ibu_hamil'] ?? 0); ?></span></div>
                        <div class="flex justify-between items-center gap-4 text-[11px] font-bold"><span class="text-sky-500"><i class="fas fa-circle text-[8px] mr-1.5"></i>Remaja</span> <span class="text-slate-800"><?php echo e($demografi['remaja'] ?? 0); ?></span></div>
                        <div class="flex justify-between items-center gap-4 text-[11px] font-bold"><span class="text-emerald-500"><i class="fas fa-circle text-[8px] mr-1.5"></i>Lansia</span> <span class="text-slate-800"><?php echo e($demografi['lansia'] ?? 0); ?></span></div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function renderDemografiChart() {
        ...
        const donutData = [
            <?php echo e($demografi['balita'] ?? 0); ?>, 
            <?php echo e($demografi['ibu_hamil'] ?? 0); ?>, 
            <?php echo e($demografi['remaja'] ?? 0); ?>, 
            <?php echo e($demografi['lansia'] ?? 0); ?>

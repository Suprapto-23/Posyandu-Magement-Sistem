...
<?php $__env->startSection('page-name', 'Koreksi Data Ibu Hamil'); ?>
...
<div class="max-w-6xl mx-auto animate-slide-up relative z-10 pb-10">
    ...
    <div class="mb-6 flex items-center gap-3 relative z-10">
        <a href="<?php echo e(route('kader.data.ibu-hamil.index')); ?>" onclick="window.showLoader()" class="w-12 h-12 rounded-[16px] bg-white border border-slate-200 text-slate-500 flex items-center justify-center hover:bg-amber-50 hover:border-amber-300 hover:text-amber-600 transition-all shadow-sm group">
    ...
    <form action="<?php echo e(route('kader.data.ibu-hamil.update', $ibuHamil->id)); ?>" method="POST" id="formBalita" class="relative z-10">
                ...
                <div class="glass-panel rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-8 md:p-10 relative overflow-hidden">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="number" name="nik" value="<?php echo e(old('nik', $ibuHamil->nik)); ?>" required class="form-input focus:ring-4 focus:ring-amber-50 <?php $__errorArgs = ['nik'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap', $ibuHamil->nama_lengkap)); ?>" required class="form-input focus:ring-4 focus:ring-amber-50">
                        </div>

                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                <label class="form-label">Tempat Lahir <span class="text-rose-500">*</span></label>
                                <input type="text" name="tempat_lahir" value="<?php echo e(old('tempat_lahir', $ibuHamil->tempat_lahir)); ?>" required class="form-input focus:ring-4 focus:ring-amber-50">
                            </div>
                            <div>
                                <label class="form-label">Tanggal Lahir <span class="text-rose-500">*</span></label>
                                <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="<?php echo e(old('tanggal_lahir', $ibuHamil->tanggal_lahir?->format('Y-m-d'))); ?>" required class="form-input cursor-pointer focus:ring-4 focus:ring-amber-50">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="nama_suami" value="<?php echo e(old('nama_suami', $ibuHamil->nama_suami)); ?>" required class="form-input focus:ring-4 focus:ring-amber-50">
                            </div>
                            <div>
                                <label class="form-label">No. HP Keluarga (Opsional)</label>
                                <input type="number" name="telepon_ortu" value="<?php echo e(old('telepon_ortu', $ibuHamil->telepon_ortu)); ?>" class="form-input focus:ring-4 focus:ring-amber-50">
                            </div>
                        </div>

                        <div>
                            <label class="form-label">Alamat Lengkap <span class="text-rose-500">*</span></label>
                            <textarea name="alamat" rows="2" required class="form-input resize-none focus:ring-4 focus:ring-amber-50"><?php echo e(old('alamat', $ibuHamil->alamat)); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-rose-50/80 rounded-[32px] border border-rose-200/80 shadow-[0_8px_30px_rgb(0,0,0,0.03)] p-8 md:p-10 relative overflow-hidden">
                    <div class="flex items-center justify-between mb-8 border-b border-rose-200 pb-5">
                        ...
                        <select name="status" class="bg-white border-2 border-rose-200 text-rose-600 font-bold text-xs rounded-full px-3 py-1 outline-none cursor-pointer">
                            ...
                            <option value="selesai" <?php echo e(old('status', $ibuHamil->status) == 'selesai' ? 'selected' : ''); ?>>Selesai (Sudah Lahir)</option>
                        </select>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div class="bg-white p-5 rounded-2xl border border-rose-100 shadow-sm">
                            ...
                            <input type="date" name="hpht" id="hpht" value="<?php echo e(old('hpht', $ibuHamil->hpht?->format('Y-m-d'))); ?>" required class="form-input bg-slate-50 focus:bg-white focus:border-rose-400">
                            ...
                            <input type="date" name="hpl" id="hpl" value="<?php echo e(old('hpl', $ibuHamil->hpl?->format('Y-m-d'))); ?>" required class="form-input bg-rose-50 border-rose-200 text-rose-800 focus:bg-white" readonly title="Dihitung Otomatis">
                        ...
                        <div>
                            ...
                            <textarea name="riwayat_penyakit" rows="2" class="form-input resize-none focus:ring-4 focus:ring-rose-50"><?php echo e(old('riwayat_penyakit', $ibuHamil->riwayat_penyakit)); ?></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-slate-800 rounded-[32px] shadow-[0_8px_30px_rgb(0,0,0,0.1)] p-8 md:p-10 relative overflow-hidden">
                    ...
                    <div class="grid grid-cols-2 gap-5 mb-5">
                        <div>
                            ...
                            <input type="number" step="0.1" name="berat_badan" id="berat_badan" value="<?php echo e(old('berat_badan', $ibuHamil->berat_badan)); ?>" class="form-input bg-slate-700 border-slate-600 text-white focus:bg-slate-600 focus:border-indigo-400 placeholder:text-slate-500">
                        </div>
                        <div>
                            <label class="form-label text-slate-400">Tinggi (cm)</label>
                            <input type="number" step="0.1" name="tinggi_badan" id="tinggi_badan" value="<?php echo e(old('tinggi_badan', $ibuHamil->tinggi_badan)); ?>" class="form-input bg-slate-700 border-slate-600 text-white focus:bg-slate-600 focus:border-indigo-400 placeholder:text-slate-500">
                        </div>
                    </div>
        ...
        <div class="p-8 border-t border-slate-100 bg-white/80 backdrop-blur-xl rounded-[32px] shadow-lg border border-white flex flex-col sm:flex-row items-center justify-end gap-4">
            <a href="<?php echo e(route('kader.data.ibu-hamil.index')); ?>" onclick="window.showLoader()" class="w-full sm:w-auto px-8 py-3.5 bg-slate-100 border border-slate-200 text-slate-600 font-extrabold text-[13px] rounded-xl hover:bg-slate-200 transition-colors text-center uppercase tracking-widest">
                Batalkan
            </a>

...
<?php $__env->startSection('title', 'Sistem E-Rujukan Medis'); ?>
<?php $__env->startSection('page-name', 'Manajemen Rujukan'); ?>
...
<div class="max-w-6xl mx-auto space-y-6 lg:space-y-8 animate-slide-up pb-10">
            ...
            <div class="flex items-start gap-5">
                ...
                <div>
                    ...
                    <p class="text-[13px] font-medium text-amber-50 max-w-xl leading-relaxed">
                        Sistem mendeteksi <b><?php echo e($rujukans->total()); ?> warga</b> yang membutuhkan penanganan lebih lanjut di Puskesmas berdasarkan hasil deteksi Stunting, Hipertensi, atau catatan tindakan Anda.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-[32px] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.03)] flex flex-col overflow-hidden">
        ...
        <div class="p-5 md:p-6 border-b border-slate-100 bg-slate-50/50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <form method="GET" action="<?php echo e(route('bidan.rujukan.index')); ?>" class="relative w-full sm:w-80">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <i class="fas fa-search text-slate-400"></i>
                </div>
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama pasien rujukan..." class="w-full bg-white border border-slate-200 rounded-[16px] pl-11 pr-4 py-3 text-[12px] font-bold text-slate-700 focus:border-amber-500 focus:ring-4 focus:ring-amber-50 outline-none transition-all shadow-sm">
            </form>
        </div>
        ...
        <div class="flex-1 overflow-x-auto custom-scrollbar p-2 md:p-4 min-h-[300px]">
            <table class="w-full text-left border-collapse min-w-[900px]">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $rujukans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rujuk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                        // Deteksi Kategori
                    ...
                    <tr class="table-row-hover transition-all duration-200 group border-b border-slate-50 last:border-0">
                        ...
                        <td class="py-4 px-6 align-middle">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-black text-slate-800 text-[14px] mb-1 group-hover:text-amber-600 transition-colors"><?php echo e($nama); ?></p>
                                    <span class="text-[9px] font-black text-<?php echo e($nCol); ?>-600 uppercase tracking-widest border border-<?php echo e($nCol); ?>-200 bg-white px-2 py-0.5 rounded shadow-sm"><?php echo e($kat); ?></span>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="py-4 px-6 align-middle">
                            <div class="flex flex-wrap gap-2">
                                <?php $__currentLoopData = $alasanRujukan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alasan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center gap-1.5 px-3 py-1.5 bg-<?php echo e($alasan['color']); ?>-50 border border-<?php echo e($alasan['color']); ?>-200 rounded-lg text-<?php echo e($alasan['color']); ?>-600">
                                        <i class="fas fa-<?php echo e($alasan['icon']); ?> text-[10px]"></i>
                                        <span class="text-[11px] font-bold"><?php echo e($alasan['text']); ?></span>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            <p class="text-[10px] font-medium text-slate-500 mt-2 truncate max-w-xs" title="<?php echo e($rujuk->diagnosa); ?>">
                                <i class="fas fa-quote-left text-slate-300 mr-1"></i> <?php echo e(Str::words($rujuk->diagnosa ?? 'Tidak ada catatan diagnosa', 6)); ?>
                        ...
                        <td class="py-4 px-6 align-middle">
                            <p class="font-bold text-slate-700 text-[12px]"><i class="far fa-calendar-alt text-slate-400 mr-1"></i> <?php echo e(\Carbon\Carbon::parse($rujuk->tanggal_periksa)->translatedFormat('d M Y')); ?></p>
                        ...
                        <td class="py-4 px-6 text-right align-middle">
                            <a href="<?php echo e(route('bidan.rujukan.cetak', $rujuk->id)); ?>" target="_blank" class="btn-print inline-flex items-center gap-2 px-6 py-3 bg-slate-900 text-white text-[11px] font-black uppercase tracking-widest rounded-[14px] hover:bg-amber-500 transition-colors shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
        ...
        <?php if($rujukans->hasPages()): ?>
        <div class="px-6 py-4 border-t border-slate-100 bg-slate-50/50">
            <?php echo e($rujukans->withQueryString()->links()); ?>
...
<?php echo $__env->make('layouts.bidan', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POSYANDU\posyandu-management-system\resources\views/bidan/rujukan/index.blade.php ENDPATH**/ ?>
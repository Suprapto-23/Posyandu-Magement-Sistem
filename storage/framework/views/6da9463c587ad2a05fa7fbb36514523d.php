<?php $__env->startSection('title', 'Layanan Telemedisin'); ?>
<?php $__env->startSection('page-name', 'Konseling Interaktif'); ?>
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('chatApp', () => ({
            ...
            fetchContacts() {
                fetch("<?php echo e(url('bidan/konseling/fetch-list')); ?>")
                    .then(res => res.json())
                    .then(data => {
                        this.contacts = data;
            ...
            openChat(user) {
                ...
                fetch("<?php echo e(url('bidan/konseling/fetch-chat')); ?>/" + user.user_id)
                    .then(res => res.json())
                    .then(data => {
                        this.chats = data;
            ...
            sendReply() {
                ...
                fetch("<?php echo e(url('bidan/konseling/reply')); ?>/" + this.activeUser.user_id, {
                    method: 'POST',
                    headers: {

<?php $__env->startSection('title', 'Electronic Medical Record'); ?>
<?php $__env->startSection('page-name', 'Detail Rekam Medis'); ?>
...
<div class="max-w-[1300px] mx-auto space-y-6 animate-slide-up pb-12">
    ...
    <div class="flex items-center justify-between px-1">
        <a href="<?php echo e(route('bidan.rekam-medis.index', ['type' => $pasien_type])); ?>" class="inline-flex items-center gap-2 text-[12px] font-bold text-slate-400 hover:text-cyan-600 transition-colors uppercase tracking-widest group">
    ...
    <div class="nexus-card">
        <div class="absolute right-0 top-0 w-64 h-64 bg-<?php echo e($themeColor); ?>-50 rounded-full blur-3xl opacity-60 -translate-y-1/3 translate-x-1/3 pointer-events-none"></div>
        
        <div class="p-6 md:p-8 flex flex-col lg:flex-row items-center gap-6 md:gap-8 relative z-10">
            <div class="w-24 h-24 md:w-28 md:h-28 rounded-[24px] bg-gradient-to-br from-<?php echo e($themeColor); ?>-400 to-<?php echo e($themeColor); ?>-600 text-white flex items-center justify-center text-4xl md:text-5xl shadow-[0_10px_25px_rgba(0,0,0,0.1)] border-[4px] border-white shrink-0">
                <i class="fas fa-<?php echo e($pasien_type == 'balita' ? 'baby' : ($pasien_type == 'ibu_hamil' ? 'female' : 'user')); ?>"></i>
            </div>
            
            <div class="flex-1 text-center lg:text-left">
                <div class="flex flex-col lg:flex-row lg:items-center gap-3 mb-3 justify-center lg:justify-start">
                    <h1 class="text-2xl md:text-3xl font-black text-slate-800 font-poppins tracking-tight"><?php echo e($nama); ?></h1>
                    <span class="px-3 py-1 bg-<?php echo e($themeColor); ?>-50 text-<?php echo e($themeColor); ?>-600 text-[10px] font-bold uppercase tracking-widest rounded-lg border border-<?php echo e($themeColor); ?>-100 shrink-0">
                        <?php echo e(str_replace('_', ' ', $pasien_type)); ?>

                    </span>
                </div>
                
                <div class="flex flex-wrap justify-center lg:justify-start gap-x-6 gap-y-3 text-slate-600 text-[13px] font-semibold">
                    <span class="flex items-center gap-1.5"><i class="fas fa-fingerprint text-slate-400 text-[14px]"></i> NIK: <?php echo e($nik); ?></span>
                    <span class="flex items-center gap-1.5"><i class="fas fa-birthday-cake text-slate-400 text-[14px]"></i> <?php echo e($tglLahir ? $tglLahir->translatedFormat('d M Y') : '-'); ?> (<?php echo e($umur); ?> Tahun)</span>
                    <span class="flex items-center gap-1.5 w-full sm:w-auto"><i class="fas fa-map-marker-alt text-slate-400 text-[14px]"></i> <?php echo e($pasien->alamat ?? 'Alamat tidak tercatat'); ?></span>
                </div>
            </div>
            ...
            <div class="flex gap-3 shrink-0 mt-4 lg:mt-0 w-full lg:w-auto justify-center">
                <div class="bg-slate-900 text-white px-5 py-4 rounded-[20px] text-center min-w-[120px] shadow-lg flex flex-col justify-center">
                    ...
                    <p class="text-2xl font-black"><?php echo e($riwayatMedis->count()); ?> <span class="text-[11px] font-medium text-slate-400">Kali</span></p>
                </div>
                <div class="bg-cyan-50 border border-cyan-100 text-cyan-800 px-5 py-4 rounded-[20px] text-center min-w-[120px] shadow-sm flex flex-col justify-center">
                    ...
                    <p class="text-2xl font-black text-cyan-600"><?php echo e($riwayatImunisasi->count()); ?> <span class="text-[11px] font-medium text-cyan-500/80">Log</span></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-4 nexus-card p-6 flex flex-col">
            ...
            <div class="space-y-3 flex-1 overflow-y-auto pr-2 custom-scrollbar max-h-[300px]">
                <?php $__empty_1 = true; $__currentLoopData = $riwayatImunisasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="p-3.5 bg-slate-50 rounded-[14px] border border-slate-100 flex justify-between items-center group hover:bg-white hover:border-teal-200 hover:shadow-sm transition-all duration-300">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="text-[13px] font-bold text-slate-800 tracking-tight"><?php echo e($imu->vaksin); ?></p>
                            <p class="text-[11px] font-medium text-slate-500 mt-0.5"><?php echo e(\Carbon\Carbon::parse($imu->tanggal_imunisasi)->translatedFormat('d M Y')); ?></p>
                        </div>
                    </div>
                    <span class="text-[10px] font-black px-2.5 py-1 bg-white border border-slate-200 text-teal-600 rounded-lg uppercase shadow-sm shrink-0"><?php echo e($imu->dosis); ?></span>
                </div>
    ...
    <div class="nexus-card">
        ...
        <div class="p-5 md:p-6 bg-slate-50/30">
            <div class="flex flex-col gap-3">
                <?php $__empty_1 = true; $__currentLoopData = $riwayatMedis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $med): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="nexus-timeline-row p-4 md:p-5 flex flex-col lg:flex-row lg:items-center w-full group relative overflow-hidden gap-4 lg:gap-0">
                    ...
                    <div class="w-full lg:w-[20%] shrink-0 pl-3">
                        <p class="text-[13px] font-bold text-slate-800"><?php echo e(\Carbon\Carbon::parse($med->tanggal_periksa)->translatedFormat('d F Y')); ?></p>
                        <p class="text-[11px] font-medium text-slate-500 font-mono mt-0.5">EMR: #<?php echo e($med->id); ?></p>
                    </div>
                    ...
                    <div class="w-full lg:w-[30%] flex flex-wrap items-center gap-4 lg:gap-6 lg:border-l lg:border-slate-100 lg:pl-6">
                        <div class="flex flex-col gap-0.5">
                            ...
                            <span class="text-[13px] font-semibold text-slate-700 flex items-center gap-1"><i class="fas fa-weight w-3 text-slate-300"></i> <?php echo e($med->berat_badan ?? 0); ?> <span class="text-[10px]">kg</span></span>
                        </div>
                        <div class="flex flex-col gap-0.5">
                            <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Tinggi</span>
                            <span class="text-[13px] font-semibold text-slate-700 flex items-center gap-1"><i class="fas fa-ruler-vertical w-3 text-slate-300"></i> <?php echo e($med->tinggi_badan ?? 0); ?> <span class="text-[10px]">cm</span></span>
                        </div>
                        <div class="flex flex-col gap-0.5">
                            <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">IMT</span>
                            <span class="text-[13px] font-bold text-cyan-600 bg-cyan-50 px-2 py-0.5 rounded"><?php echo e($med->imt ?? '-'); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="w-full lg:w-[30%] flex flex-col gap-0.5 lg:border-l lg:border-slate-100 lg:pl-6 pr-4">
                        ...
                        <p class="text-[13px] font-bold text-slate-800 truncate" title="<?php echo e($med->diagnosa ?: 'Tidak ada diagnosa spesifik'); ?>">
                            <?php echo e($med->diagnosa ?: 'Tidak ada diagnosa spesifik'); ?>

                        </p>
                        <p class="text-[11px] font-medium text-slate-500 truncate" title="<?php echo e($med->tindakan ?: 'Hanya pemeriksaan rutin.'); ?>">
                            <?php echo e($med->tindakan ?: 'Hanya pemeriksaan rutin.'); ?>
                    ...
                    <div class="w-full lg:w-[20%] flex flex-row lg:flex-col items-center lg:items-end justify-between lg:justify-center shrink-0 lg:border-l lg:border-slate-100 lg:pl-6">
                        ...
                        <div class="text-right flex flex-col items-end">
                            <span class="text-[12px] font-bold text-slate-800"><?php echo e(Str::words($med->verifikator->name ?? 'Bidan Desa', 2, '')); ?></span>

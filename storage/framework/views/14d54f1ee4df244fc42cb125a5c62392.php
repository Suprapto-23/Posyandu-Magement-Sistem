...
<div class="max-w-6xl mx-auto space-y-6 animate-slide-up pb-10">
    ...
    <div class="flex items-center justify-between mb-2">
        <a href="<?php echo e(route('bidan.rekam-medis.index', ['type' => $pasien_type])); ?>" class="inline-flex items-center gap-2 text-[12px] font-black text-slate-400 hover:text-cyan-600 transition-colors uppercase tracking-widest">
    ...
    <div class="bg-white rounded-[24px] border border-slate-100 shadow-sm overflow-hidden relative">
        <div class="absolute right-0 top-0 w-48 h-48 bg-<?php echo e($themeColor); ?>-50 rounded-full blur-3xl opacity-50 -translate-y-1/2 translate-x-1/2"></div>
        
        <div class="p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 relative z-10">
            <div class="w-24 h-24 rounded-[20px] bg-gradient-to-br from-<?php echo e($themeColor); ?>-500 to-<?php echo e($themeColor); ?>-600 text-white flex items-center justify-center text-4xl shadow-lg border-4 border-white shrink-0">
            ...
            <div class="flex-1 text-center md:text-left">
                <div class="flex flex-col md:flex-row md:items-center gap-2 mb-2 justify-center md:justify-start">
                    <h1 class="text-2xl font-black text-slate-800 font-poppins"><?php echo e($nama); ?></h1>
                    <span class="px-2.5 py-0.5 bg-<?php echo e($themeColor); ?>-50 text-<?php echo e($themeColor); ?>-600 text-[10px] font-black uppercase tracking-widest rounded-md border border-<?php echo e($themeColor); ?>-100"><?php echo e(str_replace('_', ' ', $pasien_type)); ?></span>
                </div>
                <div class="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 text-slate-500 text-[12px] font-bold">
                    <span><i class="fas fa-fingerprint mr-1.5 text-slate-300"></i> NIK: <?php echo e($nik); ?></span>
                    <span><i class="fas fa-birthday-cake mr-1.5 text-slate-300"></i> <?php echo e($tglLahir ? $tglLahir->translatedFormat('d M Y') : '-'); ?> (<?php echo e($umur); ?> Thn)</span>
                    <span class="hidden sm:inline"><i class="fas fa-map-marker-alt mr-1.5 text-slate-300"></i> <?php echo e($pasien->alamat ?? 'Alamat tidak tercatat'); ?></span>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3 shrink-0">
                <div class="bg-slate-900 text-white p-4 rounded-2xl text-center min-w-[110px] shadow-md">
                    ...
                    <p class="text-xl font-black"><?php echo e($riwayatMedis->count()); ?> <span class="text-[10px] font-medium opacity-60">Kali</span></p>
                </div>
                <div class="bg-cyan-600 text-white p-4 rounded-2xl text-center min-w-[110px] shadow-md">
                    ...
                    <p class="text-xl font-black"><?php echo e($riwayatImunisasi->count()); ?> <span class="text-[10px] font-medium opacity-60">Log</span></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="lg:col-span-4 bg-white rounded-[24px] p-6 border border-slate-100 shadow-sm flex flex-col">
            ...
            <div class="space-y-3 flex-1 overflow-y-auto pr-1 custom-scrollbar max-h-[280px]">
                ...
                <div class="p-3 bg-slate-50 rounded-xl border border-slate-100 flex justify-between items-center group hover:border-teal-200 transition-colors">
                    <div>
                        <p class="text-[12px] font-black text-slate-800"><?php echo e($imu->vaksin); ?></p>
                        <p class="text-[10px] font-bold text-slate-400 italic"><?php echo e(\Carbon\Carbon::parse($imu->tanggal_imunisasi)->translatedFormat('d M Y')); ?></p>
                    </div>
                    <span class="text-[9px] font-black px-2 py-1 bg-white border border-slate-200 text-teal-600 rounded-lg uppercase shadow-sm"><?php echo e($imu->dosis); ?></span>
                </div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-all text-[13px] group">
                        <td class="py-5 px-8">
                            <p class="font-black text-slate-800"><?php echo e(\Carbon\Carbon::parse($med->tanggal_periksa)->translatedFormat('d F Y')); ?></p>
                            <p class="text-[11px] font-bold text-slate-400 mt-0.5">EMR ID: #<?php echo e($med->id); ?></p>
                        </td>
                        <td class="py-5 px-8">
                            <div class="flex items-center gap-3">
                                <div class="flex flex-col">
                                    <span class="text-[10px] font-black text-slate-400 uppercase tracking-tighter">Berat</span>
                                    <span class="font-bold text-slate-700"><?php echo e($med->berat_badan ?? 0); ?> kg</span>
                                </div>
                                <div class="w-px h-6 bg-slate-200"></div>
                                <div class="flex flex-col">
                                    <span class="text-[10px] font-black text-slate-400 uppercase tracking-tighter">Tinggi</span>
                                    <span class="font-bold text-slate-700"><?php echo e($med->tinggi_badan ?? 0); ?> cm</span>
                                </div>
                                <div class="w-px h-6 bg-slate-200"></div>
                                <div class="flex flex-col">
                                    <span class="text-[10px] font-black text-slate-400 uppercase tracking-tighter">IMT</span>
                                    <span class="font-black text-cyan-600"><?php echo e($med->imt ?? '-'); ?></span>
                                </div>
                            </div>
                        </td>
                        <td class="py-5 px-8">
                            <p class="font-bold text-slate-800 mb-1 line-clamp-1"><?php echo e($med->diagnosa ?: 'Tidak ada diagnosa spesifik'); ?></p>
                            <p class="text-[11px] text-slate-500 leading-relaxed italic line-clamp-2"><?php echo e($med->tindakan ?: 'Hanya pemeriksaan rutin.'); ?></p>
                        </td>
                        <td class="py-5 px-8 text-right">
                            <div class="flex flex-col items-end">
                                <span class="text-[11px] font-black text-slate-800"><?php echo e(Str::words($med->verifikator->name ?? 'Bidan Desa', 1, '')); ?></span>

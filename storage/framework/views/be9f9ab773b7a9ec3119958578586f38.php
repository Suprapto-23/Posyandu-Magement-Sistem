...
<aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-[280px] bg-white border-r border-slate-200/80 layout-transition flex flex-col shadow-2xl lg:shadow-none">
    ...
    <nav class="flex-1 overflow-y-auto px-4 py-6 custom-scrollbar space-y-7">
        ...
        <div>
            ...
            <a href="<?php echo e(route('kader.dashboard')); ?>" class="loader-trigger group flex items-center gap-3 px-4 py-3 rounded-2xl text-[13.5px] menu-transition <?php echo e($route == 'kader.dashboard' ? $menuAktif : $menuPasif); ?>">
        ...
        <div>
            ...
            <div class="space-y-1">
                ...
                <div id="menuAbsensi" class="submenu-grid <?php echo e($isAbsensi ? 'grid-rows-[1fr]' : 'grid-rows-[0fr]'); ?>">
                    <div class="overflow-hidden">
                        <div class="pl-[48px] pr-2 py-1 space-y-1 relative before:absolute before:left-[26px] before:top-3 before:bottom-3 before:w-[2px] before:bg-slate-100 before:rounded-full">
                            <a href="<?php echo e(route('kader.absensi.index')); ?>" class="loader-trigger block px-4 py-2.5 text-[12.5px] rounded-xl menu-transition relative before:absolute before:left-[-25.5px] before:top-1/2 before:-translate-y-1/2 before:w-[7px] before:h-[7px] before:rounded-full <?php echo e($route == 'kader.absensi.index' ? 'font-bold text-indigo-700 bg-white shadow-sm border border-slate-100 before:bg-indigo-500 before:ring-4 before:ring-indigo-100' : 'font-medium text-slate-500 hover:text-slate-800 hover:bg-slate-50 before:bg-slate-200 hover:before:bg-indigo-300'); ?>">Buka Sesi Absen</a>
                            <a href="<?php echo e(route('kader.absensi.riwayat')); ?>" class="loader-trigger block px-4 py-2.5 text-[12.5px] rounded-xl menu-transition relative before:absolute before:left-[-25.5px] before:top-1/2 before:-translate-y-1/2 before:w-[7px] before:h-[7px] before:rounded-full <?php echo e(in_array($route, ['kader.absensi.riwayat', 'kader.absensi.show']) ? 'font-bold text-indigo-700 bg-white shadow-sm border border-slate-100 before:bg-indigo-500 before:ring-4 before:ring-indigo-100' : 'font-medium text-slate-500 hover:text-slate-800 hover:bg-slate-50 before:bg-slate-200 hover:before:bg-indigo-300'); ?>">Riwayat Arsip</a>
                        </div>
                    </div>
                </div>
                
                <a href="<?php echo e(route('kader.pemeriksaan.index')); ?>" class="loader-trigger group flex items-center gap-3 px-4 py-3 rounded-2xl text-[13.5px] menu-transition <?php echo e(Str::startsWith($route, 'kader.pemeriksaan') ? $menuAktif : $menuPasif); ?>">
                    <i class="fas fa-balance-scale w-5 text-center text-[16px] <?php echo e(Str::startsWith($route, 'kader.pemeriksaan') ? $iconAktif : $iconPasif); ?>"></i> 
                    <span>Pengukuran Fisik</span>
                </a>

                <a href="<?php echo e(route('kader.imunisasi.index')); ?>" class="loader-trigger group flex items-center gap-3 px-4 py-3 rounded-2xl text-[13.5px] menu-transition <?php echo e(Str::startsWith($route, 'kader.imunisasi') ? $menuAktif : $menuPasif); ?>">
                    <i class="fas fa-shield-virus w-5 text-center text-[16px] <?php echo e(Str::startsWith($route, 'kader.imunisasi') ? $iconAktif : $iconPasif); ?>"></i> 
                    <span>Tracker Imunisasi Bidan</span>
                </a>

                <a href="<?php echo e(route('kader.kunjungan.index')); ?>" class="loader-trigger group flex items-center gap-3 px-4 py-3 rounded-2xl text-[13.5px] menu-transition <?php echo e(Str::startsWith($route, 'kader.kunjungan') ? $menuAktif : $menuPasif); ?>">
                    <i class="fas fa-book-medical w-5 text-center text-[16px] <?php echo e(Str::startsWith($route, 'kader.kunjungan') ? $iconAktif : $iconPasif); ?>"></i> 
        ...
        <div>
            ...
            <div class="space-y-1">
                <a href="<?php echo e(route('kader.jadwal.index')); ?>" class="loader-trigger group flex items-center gap-3 px-4 py-3 rounded-2xl text-[13.5px] menu-transition <?php echo e(Str::startsWith($route, 'kader.jadwal') ? $menuAktif : $menuPasif); ?>">
                ...
                <a href="<?php echo e(route('kader.import.index')); ?>" class="loader-trigger group flex items-center gap-3 px-4 py-3 rounded-2xl text-[13.5px] menu-transition <?php echo e(Str::startsWith($route, 'kader.import') ? $menuAktif : $menuPasif); ?>">
                    <i class="fas fa-cloud-upload-alt w-5 text-center text-[16px] <?php echo e(Str::startsWith($route, 'kader.import') ? $iconAktif : $iconPasif); ?>"></i> 
                    <span>Import Data Excel</span>
                </a>
                <a href="<?php echo e(route('kader.laporan.index')); ?>" class="loader-trigger group flex items-center gap-3 px-4 py-3 rounded-2xl text-[13.5px] menu-transition <?php echo e(Str::startsWith($route, 'kader.laporan') ? $menuAktif : $menuPasif); ?>">
                    <i class="fas fa-file-pdf w-5 text-center text-[16px] <?php echo e(Str::startsWith($route, 'kader.laporan') ? $iconAktif : $iconPasif); ?>"></i> 
    ...
    <div class="p-4 border-t border-slate-100 bg-white shrink-0">
        <a href="<?php echo e(route('kader.profile.index')); ?>" class="flex items-center gap-3 p-2 rounded-xl hover:bg-slate-50 transition-colors group loader-trigger">

...
<div class="animate-slide-up">
    ...
    <div class="hero">
        ...
        <div class="hero-txt">
            ...
            <h1 class="hero-title">Selamat Datang,<br><span>Kader <?php echo e(Str::words(Auth::user()->profile->full_name ?? 'Hebat', 2, '')); ?>!</span> 👋</h1>
            ...
            <div class="flex flex-wrap items-center gap-3 mt-4">
                <div class="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-white text-[13px] font-bold">
                    <i class="fas fa-calendar-day text-indigo-200"></i> <?php echo e(now()->translatedFormat('l, d F Y')); ?>

                </div>
                <div class="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-white text-[13px] font-bold">
                    <i class="fas fa-users text-emerald-300"></i> <?php echo e(($stats['total_balita']??0)+($stats['total_remaja']??0)+($stats['total_lansia']??0)); ?> Warga Terdaftar
                </div>
            </div>
        </div>
    ...
    <div class="stats-grid">
        <div class="stat-card group">
            ...
            <div class="flex items-end justify-between">
                <h3 class="stat-value"><?php echo e($stats['total_balita'] ?? 0); ?></h3>
        ...
        <div class="stat-card group">
            ...
            <div class="flex items-end justify-between">
                <h3 class="stat-value"><?php echo e($stats['total_remaja'] ?? 0); ?></h3>
        ...
        <div class="stat-card group">
            ...
            <div class="flex items-end justify-between">
                <h3 class="stat-value"><?php echo e($stats['total_lansia'] ?? 0); ?></h3>
        ...
        <div class="stat-card group">
            ...
            <div class="flex items-end justify-between">
                <h3 class="stat-value"><?php echo e($stats['jadwal_hari_ini'] ?? 0); ?></h3>
        ...
        <div class="lg:col-span-2 bg-white rounded-[32px] border border-slate-200/80 shadow-[0_8px_30px_rgba(0,0,0,0.03)] p-6 md:p-8 flex flex-col">
            <div class="flex flex-wrap items-center justify-between gap-4 mb-8">
                ...
                <div class="flex items-center gap-2">
                    <a href="<?php echo e(route('kader.kunjungan.index')); ?>" class="px-4 py-2 bg-slate-50 hover:bg-slate-100 text-slate-600 text-[12px] font-bold rounded-xl transition-colors border border-slate-200 flex items-center gap-1.5">
                        <i class="fas fa-arrow-up-right-from-square"></i> Detail
                    </a>
                    <a href="<?php echo e(route('kader.laporan.index')); ?>" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-[12px] font-bold rounded-xl transition-all shadow-sm hover:shadow-md flex items-center gap-1.5">
        ...
        <div class="bg-white rounded-[32px] border border-slate-200/80 shadow-[0_8px_30px_rgba(0,0,0,0.03)] p-6 md:p-8 flex flex-col">
            ...
            <div class="flex flex-col gap-3 mt-auto">
                <div class="flex items-center justify-between p-3.5 rounded-2xl bg-rose-50/50 border border-rose-100 hover:bg-rose-50 transition-colors">
                    ...
                    <span class="text-[15px] font-black text-slate-900 font-poppins"><?php echo e($stats['total_balita'] ?? 0); ?></span>
                </div>
                <div class="flex items-center justify-between p-3.5 rounded-2xl bg-sky-50/50 border border-sky-100 hover:bg-sky-50 transition-colors">
                    ...
                    <span class="text-[15px] font-black text-slate-900 font-poppins"><?php echo e($stats['total_remaja'] ?? 0); ?></span>
                </div>
                <div class="flex items-center justify-between p-3.5 rounded-2xl bg-amber-50/50 border border-amber-100 hover:bg-amber-50 transition-colors">
                    ...
                    <span class="text-[15px] font-black text-slate-900 font-poppins"><?php echo e($stats['total_lansia'] ?? 0); ?></span>
                </div>
            </div>
        </div>

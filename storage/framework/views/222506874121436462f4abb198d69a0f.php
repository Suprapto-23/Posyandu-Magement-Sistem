...
<div class="max-w-[1400px] mx-auto pb-8 space-y-6">
    ...
    <div class="clean-card p-8 md:p-12 flex flex-col items-center text-center fade-in-up relative overflow-hidden">
        ...
        <h1 class="text-3xl md:text-[42px] font-extrabold text-slate-900 tracking-tight leading-tight mb-3" style="font-family:'Syne',sans-serif;">
            Halo, <span class="text-indigo-600"><?php echo e(Str::words(Auth::user()->profile->full_name ?? 'Kader', 2, '')); ?>!</span> 👋
        </h1>
        ...
        <div class="flex flex-wrap justify-center items-center gap-3">
            ...
            <div class="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-600 text-[13px] font-semibold">
                ...
                <?php echo e(($stats['total_balita']??0)+($stats['total_remaja']??0)+($stats['total_lansia']??0)+($stats['total_ibu_hamil']??0)); ?> Warga Terdaftar
            </div>
            <a href="<?php echo e(route('kader.kunjungan.index')); ?>" class="smooth-route flex items-center gap-2 px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-[13px] font-semibold transition-colors shadow-sm shadow-indigo-200">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 fade-in-up delay-1">
        ...
        <div class="clean-card p-6 flex flex-col items-center text-center">
            <div class="stat-icon" style="background:<?php echo e($c['iconBg']); ?>;color:<?php echo e($c['iconColor']); ?>;">
                <i class="fas <?php echo e($c['icon']); ?>"></i>
            </div>
            <p class="text-[36px] font-extrabold text-slate-900 leading-none mb-1.5" style="font-family:'Syne',sans-serif;"><?php echo e($c['val']); ?></p>
            <p class="text-[11px] font-semibold text-slate-400 uppercase tracking-widest"><?php echo e($c['label']); ?></p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 fade-in-up delay-2">
        ...
        <div class="lg:col-span-2 clean-card p-7 flex flex-col">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('kader.kunjungan.index')); ?>" class="smooth-route hidden sm:flex items-center gap-1.5 px-4 py-2 bg-slate-50 hover:bg-indigo-50 hover:text-indigo-600 text-slate-600 text-[12px] font-semibold rounded-xl transition-colors border border-slate-200">
                ...
                <div class="tl-item">
                    ...
                    <div class="hover:bg-slate-50 rounded-xl p-3 -ml-1 transition-colors">
                        <div class="flex items-start justify-between gap-2 mb-0.5">
                            <p class="text-[13px] font-semibold text-slate-800 leading-tight"><?php echo e($kunj->pasien->nama_lengkap ?? 'Warga'); ?></p>
                            <span class="text-[10px] text-slate-400 shrink-0 font-medium"><?php echo e($kunj->created_at->diffForHumans(null, true, true)); ?></span>
                        </div>
                        ...
                        <span class="inline-flex items-center gap-1 text-[9px] font-bold px-2 py-0.5 bg-slate-100 text-slate-500 rounded-md border border-slate-200 uppercase tracking-wide">
                            <i class="fas fa-tag text-[8px]"></i> <?php echo e(class_basename($kunj->pasien_type)); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 fade-in-up delay-3">
        ...
        <div class="lg:col-span-2 clean-card p-7">
            <div class="flex items-center justify-between mb-5">
                ...
                <a href="<?php echo e(route('kader.jadwal.index')); ?>" class="smooth-route text-[12px] font-semibold text-indigo-600 hover:text-indigo-700 bg-indigo-50 hover:bg-indigo-100 px-4 py-2 rounded-xl transition-colors">
                    Lihat Semua
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <a href="<?php echo e(route('kader.jadwal.show', $jdw->id)); ?>" class="jadwal-item smooth-route group">
                    <div class="jadwal-date">
                        <span class="text-[9px] font-bold text-slate-400 uppercase tracking-wide group-hover:text-indigo-400 transition-colors"><?php echo e(\Carbon\Carbon::parse($jdw->tanggal)->translatedFormat('M')); ?></span>
                        <span class="text-[19px] font-extrabold text-slate-800 leading-none mt-0.5" style="font-family:'Syne',sans-serif;"><?php echo e(\Carbon\Carbon::parse($jdw->tanggal)->format('d')); ?></span>
                    </div>
                    <div class="flex-1 min-w-0">
                        <h4 class="text-[13px] font-semibold text-slate-800 truncate mb-1 group-hover:text-indigo-600 transition-colors"><?php echo e($jdw->judul); ?></h4>
                        <p class="text-[12px] text-slate-400 flex items-center gap-1.5">
                            <i class="far fa-clock text-[11px]"></i>
                            <?php echo e(\Carbon\Carbon::parse($jdw->waktu_mulai)->format('H:i')); ?> WIB
                        </p>
                    </div>
        ...
        <div class="clean-card p-7 flex flex-col">
            ...
            <?php $totalW = ($stats['total_balita']??0)+($stats['total_remaja']??0)+($stats['total_lansia']??0)+($stats['total_ibu_hamil']??0); ?>
            ...
            <div class="relative mx-auto mb-6" style="width:170px;height:170px;">
                <?php if($totalW > 0): ?>
                    ...
                    <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                        ...
                        <span class="text-[30px] font-extrabold text-slate-900 leading-tight mt-0.5" style="font-family:'Syne',sans-serif;"><?php echo e($totalW); ?></span>
                    </div>
                <?php else: ?>
            ...
            <div class="space-y-2 mt-auto">
                ...
                <div class="legend-row">
                    <div class="flex items-center gap-2.5">
                        <span class="w-2.5 h-2.5 rounded-full shrink-0" style="background:<?php echo e($d['hex']); ?>;"></span>
                        <span class="text-[12px] font-semibold text-slate-600"><?php echo e($d['label']); ?></span>
                    </div>
                    <span class="text-[14px] font-bold text-slate-800" style="font-family:'Syne',sans-serif;"><?php echo e($d['val']); ?></span>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>

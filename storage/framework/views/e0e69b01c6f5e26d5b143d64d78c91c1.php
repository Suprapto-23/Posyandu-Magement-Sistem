    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-gradient-to-br from-pink-500 to-rose-400 rounded-3xl p-5 text-white shadow-md relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <div class="flex items-baseline gap-1">
                    <span class="text-3xl font-black"><?php echo e($usiaHamilMinggu ?? '-'); ?></span>
        ...
        <div class="bg-white border border-slate-100 rounded-3xl p-5 shadow-sm">
            ...
            <h3 class="text-lg font-black text-slate-800 mt-1">
                <?php echo e($ibuHamil->hpl ? \Carbon\Carbon::parse($ibuHamil->hpl)->translatedFormat('d F Y') : 'Belum Ditentukan'); ?>
        ...
        <div class="bg-white border border-slate-100 rounded-3xl p-5 shadow-sm">
            ...
            <h3 class="text-lg font-black text-slate-800 mt-1">
                <?php echo e($ibuHamil->hpht ? \Carbon\Carbon::parse($ibuHamil->hpht)->translatedFormat('d M Y') : '-'); ?>
        ...
        <div class="bg-white border border-slate-100 rounded-3xl p-5 shadow-sm">
            ...
            <div class="mt-1">
                <?php if(strtolower($ibuHamil->status ?? 'aktif') == 'aktif'): ?>
            ...
            <div class="bg-white rounded-[2rem] border border-slate-100 shadow-sm p-6 lg:p-8">
                ...
                <div class="space-y-4">
                    <div class="pb-3 border-b border-slate-50">
                        ...
                        <p class="text-sm font-bold text-slate-800"><?php echo e($ibuHamil->nama_lengkap ?? $user->name); ?></p>
                    </div>
                    <div class="pb-3 border-b border-slate-50">
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Nomor Induk Kependudukan (NIK)</p>
                        <p class="text-sm font-bold text-slate-800"><?php echo e($ibuHamil->nik); ?></p>
                    </div>
                    <div class="pb-3 border-b border-slate-50">
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Nama Suami</p>
                        <p class="text-sm font-bold text-slate-800"><?php echo e($ibuHamil->nama_suami ?? '-'); ?></p>
                    </div>
                    <div class="pb-3 border-b border-slate-50">
                        <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Riwayat G-P-A (Gravida-Partus-Abortus)</p>
                        <p class="text-sm font-bold text-slate-800">
                            <?php if(isset($ibuHamil->gravida)): ?>
                                G: <?php echo e($ibuHamil->gravida); ?> | P: <?php echo e($ibuHamil->partus ?? 0); ?> | A: <?php echo e($ibuHamil->abortus ?? 0); ?>
                        ...
                        <div class="mb-5 last:mb-0 relative pl-6 md:pl-8 py-2">
                            ...
                            <div class="bg-slate-50 hover:bg-pink-50/50 border border-slate-100 hover:border-pink-100 rounded-2xl p-5 transition-colors">
                                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
                                    <div>
                                        <h4 class="text-sm font-black text-slate-800"><?php echo e(\Carbon\Carbon::parse($periksa->tanggal_periksa)->translatedFormat('l, d F Y')); ?></h4>
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    <div class="bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                                        ...
                                        <p class="text-sm font-bold text-slate-800"><?php echo e($periksa->berat_badan ?? '-'); ?> <span class="text-[10px] text-slate-400">kg</span></p>
                                    </div>
                                    <div class="bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-wider mb-1">Tekanan Darah</p>
                                        <p class="text-sm font-bold text-slate-800"><?php echo e($periksa->tekanan_darah ?? '-'); ?></p>
                                    </div>
                                    <div class="bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-wider mb-1">TFU (Tinggi Fundus)</p>
                                        <p class="text-sm font-bold text-slate-800"><?php echo e($periksa->tfu ?? '-'); ?> <span class="text-[10px] text-slate-400">cm</span></p>
                                    </div>
                                    <div class="bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                                        <p class="text-[9px] font-black text-slate-400 uppercase tracking-wider mb-1">Detak Jantung Janin</p>
                                        <p class="text-sm font-bold text-slate-800"><?php echo e($periksa->djj ?? '-'); ?> <span class="text-[10px] text-slate-400">bpm</span></p>
                                    </div>
                                </div>
                                
                                <?php if(!empty($periksa->keterangan)): ?>
                                    <div class="mt-3 pt-3 border-t border-slate-100">
                                        ...
                                        <p class="text-xs font-medium text-slate-700 leading-relaxed italic">"<?php echo e($periksa->keterangan); ?>"</p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POSYANDU\posyandu-management-system\resources\views/user/ibu-hamil/index.blade.php ENDPATH**/ ?>
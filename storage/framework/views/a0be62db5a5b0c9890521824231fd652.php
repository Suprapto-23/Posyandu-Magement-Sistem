...
<?php $__env->startSection('title', 'Edit Data Bidan'); ?>
<?php $__env->startSection('page-name', 'Edit Bidan'); ?>
...
<div class="max-w-4xl mx-auto animate-pop-in">
    ...
    <div class="bg-gradient-to-br from-sky-500 to-teal-500 rounded-[2.5rem] p-8 md:p-10 mb-8 relative overflow-hidden shadow-lg border border-white/20 flex flex-col items-center justify-center text-center group">
        ...
        <div class="relative z-10 w-full flex flex-col items-center">
            ...
            <h2 class="text-3xl font-black text-white font-poppins tracking-tight flex items-center justify-center gap-3 text-shadow-sm">
                <i class="fas fa-user-edit"></i> Edit: <?php echo e($bidan->profile->full_name ?? $bidan->name); ?>
    ...
    <form action="<?php echo e(route('admin.bidans.update', $bidan->id)); ?>" method="POST" id="bidanForm">
            ...
            <div class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2 text-center md:text-left opacity-70">
                        ...
                        <input type="text" value="<?php echo e($bidan->profile?->nik ?? $bidan->nik ?? '-'); ?>" readonly class="w-full bg-slate-100 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-400 cursor-not-allowed">
                    </div>

                    <div class="space-y-2 text-center md:text-left opacity-70">
                        <label class="text-[11px] font-black text-slate-500 uppercase tracking-widest">Email (Username)</label>
                        <input type="email" value="<?php echo e($bidan->email); ?>" readonly class="w-full bg-slate-100 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-400 cursor-not-allowed">
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2 space-y-2 text-center md:text-left border-t border-slate-100 mt-2 pt-6">
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name', $bidan->profile?->full_name ?? $bidan->name)); ?>" required class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-800 focus:bg-white focus:border-teal-400 focus:ring-4 focus:ring-teal-500/10 outline-none transition-all">
                    </div>
                    ...
                    <div class="space-y-2 text-center md:text-left">
                        ...
                        <select name="jenis_kelamin" required class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-800 focus:bg-white focus:border-teal-400 focus:ring-4 focus:ring-teal-500/10 outline-none transition-all cursor-pointer">
                            ...
                            <option value="L" <?php echo e(old('jenis_kelamin', $bidan->profile?->jenis_kelamin) == 'L' ? 'selected' : ''); ?>>Laki-Laki</option>
                            <option value="P" <?php echo e(old('jenis_kelamin', $bidan->profile?->jenis_kelamin) == 'P' ? 'selected' : ''); ?>>Perempuan</option>
                        </select>
                    </div>

                    <div class="space-y-2 text-center md:text-left">
                        <label class="text-[11px] font-black text-slate-500 uppercase tracking-widest">Nomor Telepon/WA</label>
                        <input type="text" name="telepon" id="telepon" value="<?php echo e(old('telepon', $bidan->profile?->telepon)); ?>" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-800 focus:bg-white focus:border-teal-400 focus:ring-4 focus:ring-teal-500/10 outline-none transition-all">
                    </div>

                    <div class="space-y-2 text-center md:text-left">
                        <label class="text-[11px] font-black text-slate-500 uppercase tracking-widest">Tempat Lahir</label>
                        <input type="text" name="tempat_lahir" value="<?php echo e(old('tempat_lahir', $bidan->profile?->tempat_lahir)); ?>" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-800 focus:bg-white focus:border-teal-400 focus:ring-4 focus:ring-teal-500/10 outline-none transition-all">
                    </div>
                    ...
                    <div class="space-y-2 text-center md:text-left">
                        ...
                        <input type="date" name="tanggal_lahir" value="<?php echo e(old('tanggal_lahir', $bidan->profile?->tanggal_lahir)); ?>" required class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-800 focus:bg-white focus:border-teal-400 focus:ring-4 focus:ring-teal-500/10 outline-none transition-all">
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2 space-y-2 text-center md:text-left">
                        ...
                        <input type="text" name="alamat" value="<?php echo e(old('alamat', $bidan->profile?->alamat)); ?>" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-800 focus:bg-white focus:border-teal-400 focus:ring-4 focus:ring-teal-500/10 outline-none transition-all">
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2 space-y-2 text-center md:text-left mt-2">
                        ...
                        <select name="status" required class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-black text-slate-800 focus:bg-white focus:border-teal-400 outline-none transition-all cursor-pointer">
                            <option value="active" <?php echo e(old('status', $bidan->status) == 'active' ? 'selected' : ''); ?>>🟢 AKTIF</option>
                            <option value="inactive" <?php echo e(old('status', $bidan->status) == 'inactive' ? 'selected' : ''); ?>>🔴 NONAKTIF</option>
                        </select>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POSYANDU\posyandu-management-system\resources\views/admin/bidans/edit.blade.php ENDPATH**/ ?>
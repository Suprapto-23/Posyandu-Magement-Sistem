...
<div class="max-w-[1400px] mx-auto animate-slide-up">
    ...
    <div class="bg-white rounded-[24px] border border-slate-200/80 shadow-[0_8px_30px_rgb(0,0,0,0.03)] p-4 mb-6 flex flex-col lg:flex-row items-center justify-between gap-4 relative z-20">
        ...
        <div class="flex gap-2 w-full lg:w-auto overflow-x-auto custom-scrollbar pb-1 sm:pb-0">
            ...
            <?php $__currentLoopData = ['semua'=>'Semua Data', 'balita'=>'Balita', 'remaja'=>'Remaja (HPV/TT)', 'lansia'=>'Lansia']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(request()->fullUrlWithQuery(['kategori'=>$k, 'page'=>1])); ?>" 
                   ...
                   <?php if($k == 'balita'): ?> <i class="fas fa-baby <?php echo e($currentCat == $k ? 'text-white' : 'text-rose-400'); ?>"></i> 
                   <?php elseif($k == 'remaja'): ?> <i class="fas fa-user-graduate <?php echo e($currentCat == $k ? 'text-white' : 'text-sky-400'); ?>"></i> 
                   <?php elseif($k == 'lansia'): ?> <i class="fas fa-wheelchair <?php echo e($currentCat == $k ? 'text-white' : 'text-amber-400'); ?>"></i> 
                   <?php endif; ?>
                   <?php echo e($l); ?>
        ...
        <div class="w-full lg:w-96 relative">
            ...
            <input type="text" id="searchInput" value="<?php echo e($search ?? ''); ?>" placeholder="Cari nama pasien atau vaksin..." class="search-input" autocomplete="off">
                    ...
                    <tbody class="divide-y divide-slate-50">
                        ...
                        <tr class="hover:bg-slate-50/80 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-xl bg-indigo-50 flex flex-col items-center justify-center text-indigo-700 border border-indigo-100">
                                        ...
                                        <span class="text-[9px] font-bold uppercase"><?php echo e(\Carbon\Carbon::parse($imun->tanggal_imunisasi)->translatedFormat('M')); ?></span>
                                    </div>
                                    <div class="text-[12px] font-bold text-slate-500"><?php echo e(\Carbon\Carbon::parse($imun->tanggal_imunisasi)->format('Y')); ?></div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                ...
                                ?>
                                <p class="font-bold text-slate-800 text-sm mb-1 font-poppins"><?php echo e($namaPasien); ?></p>
                                <span class="inline-block px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-widest border <?php echo e($badge[0]); ?> <?php echo e($badge[1]); ?> <?php echo e($badge[2]); ?>">
                                    <?php echo e($tipePasien); ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-[13px] font-bold text-slate-800 mb-0.5"><?php echo e($imun->vaksin); ?></p>
                                        <p class="text-[11px] font-bold text-slate-500">Dosis: <span class="text-indigo-600"><?php echo e($imun->dosis); ?></span> &middot; <?php echo e($imun->jenis_imunisasi); ?></p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="inline-flex items-center justify-center gap-2 bg-white px-3 py-1.5 rounded-lg border border-slate-200 shadow-sm">
                                    ...
                                    <span class="text-[11px] font-bold text-slate-600 truncate max-w-[100px]"><?php echo e($imun->kunjungan?->petugas?->name ?? 'Bidan Desa'); ?></span>
                                </div>
                            </td>

                            <td class="px-6 py-4 text-right">
                                <a href="<?php echo e(route('kader.imunisasi.show', $imun->id)); ?>" class="inline-flex w-9 h-9 rounded-xl bg-white border border-slate-200 items-center justify-center text-slate-500 hover:text-indigo-600 hover:border-indigo-300 hover:bg-indigo-50 shadow-sm transition-all" title="Detail Imunisasi">
...
<?php echo $__env->make('layouts.kader', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POSYANDU\posyandu-management-system\resources\views/kader/imunisasi/index.blade.php ENDPATH**/ ?>
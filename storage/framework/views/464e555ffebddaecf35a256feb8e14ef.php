...
<div class="max-w-[1400px] mx-auto animate-slide-up">
    ...
    <div class="bg-white rounded-[24px] border border-slate-200/80 shadow-sm p-4 mb-6 flex flex-col lg:flex-row items-center justify-between gap-4 relative z-20">
        ...
        <div class="flex gap-2 w-full lg:w-auto overflow-x-auto custom-scrollbar pb-2 sm:pb-0 justify-start sm:justify-center">
            ...
            <?php $__currentLoopData = [
                ...
                <a href="<?php echo e(request()->fullUrlWithQuery(['kategori'=>$k, 'page'=>1])); ?>" 
                   ...
                   <?php if($v['icon']): ?> <i class="fas <?php echo e($v['icon']); ?>"></i> <?php endif; ?>
                   <?php echo e($v['label']); ?>
        ...
        <div class="w-full lg:w-96 relative group">
            ...
            <input type="text" id="searchInput" value="<?php echo e($search ?? ''); ?>" placeholder="Ketik nama warga atau vaksin..." class="search-input" autocomplete="off">
    ...
    <div id="table-container" class="relative transition-opacity duration-300">
        ...
        <div class="bg-white rounded-[24px] border border-slate-200/80 shadow-sm overflow-hidden">
                        ...
                        <tr class="hover:bg-indigo-50/30 transition-colors even:bg-slate-50/40">
                            ...
                            <td class="px-6 py-3.5 border-r border-slate-200/50">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-[12px] font-black text-slate-800"><?php echo e(\Carbon\Carbon::parse($imun->tanggal_imunisasi)->translatedFormat('F Y')); ?></p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-3.5 border-r border-slate-200/50">
                                ...
                                ?>
                                <p class="font-black text-slate-800 text-[13px] mb-1 truncate max-w-[200px]"><?php echo e($imun->profil_pasien?->nama_lengkap ?? 'Mencari data...'); ?></p>
                                <span class="inline-block px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-widest border <?php echo e($badge); ?>">
                                    <?php echo e($tipeLengkap); ?>
                            ...
                            <td class="px-6 py-3.5 border-r border-slate-200/50">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-[13px] font-black text-slate-800"><?php echo e($imun->vaksin); ?></p>
                                        <p class="text-[10px] font-bold text-slate-500">Dosis: <span class="text-indigo-600"><?php echo e($imun->dosis); ?></span> &middot; <?php echo e($imun->jenis_imunisasi); ?></p>
                                    </div>
                                </div>
                            </td>

                            <td class="px-6 py-3.5 text-center border-r border-slate-200/50">
                                <span class="text-[11px] font-bold text-slate-600 bg-white border border-slate-200 px-3 py-1.5 rounded-lg shadow-sm"><i class="fas fa-user-md text-slate-400 mr-1"></i> <?php echo e($imun->kunjungan?->petugas?->name ?? 'Bidan'); ?></span>
                            </td>

                            <td class="px-6 py-3.5 text-center">
                                <a href="<?php echo e(route('kader.imunisasi.show', $imun->id)); ?>" class="inline-flex w-9 h-9 rounded-xl bg-white border border-slate-200 items-center justify-center text-slate-500 hover:text-indigo-600 hover:border-indigo-300 hover:bg-indigo-50 shadow-sm transition-all" title="Detail Sertifikat">
            ...
            <div id="paginationArea" class="px-6 py-4 border-t border-slate-100 bg-slate-50/50">
                <?php if(isset($imunisasis) && $imunisasis->hasPages()): ?> <?php echo e($imunisasis->links()); ?> <?php endif; ?>
            </div>
        </div>
    </div>
</div>

...
<?php $__env->startSection('title', 'Generator Laporan PDF'); ?>
<?php $__env->startSection('page-name', 'Pusat Arsip Digital'); ?>
...
<div class="max-w-[1300px] mx-auto fade-in-up pb-16 relative z-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10 justify-center">
        <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php $staggerClass = 'stagger-' . (($index % 5) + 1); ?>
        
        <div class="report-card p-8 flex flex-col group <?php echo e($staggerClass); ?>">
            <div class="flex items-center gap-5 mb-8">
                <div class="w-16 h-16 rounded-[20px] bg-<?php echo e($r['base']); ?>-50 text-<?php echo e($r['base']); ?>-500 flex items-center justify-center text-3xl border border-<?php echo e($r['base']); ?>-100 shrink-0 group-hover:scale-110 transition-transform duration-300 shadow-sm">
                    <i class="fas <?php echo e($r['icon']); ?>"></i>
                </div>
                <div>
                    <h3 class="font-black text-slate-800 text-[18px] font-poppins leading-tight"><?php echo e($r['title']); ?></h3>
                    <p class="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-widest"><?php echo e($r['desc']); ?></p>
                </div>
            </div>

            <form action="<?php echo e(route('kader.laporan.generate')); ?>" method="GET" class="mt-auto flex flex-col gap-5">
                <input type="hidden" name="type" value="<?php echo e($r['type']); ?>">
                
                <div class="flex items-center gap-3">
                    <div class="w-3/5 relative">
                        <select name="bulan" class="select-capsule w-full">
                            <?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e(str_pad($m, 2, '0', STR_PAD_LEFT)); ?>" <?php echo e($currentMonth == $m ? 'selected' : ''); ?>>
                                    <?php echo e(\Carbon\Carbon::create()->month((int)$m)->locale('id')->translatedFormat('F')); ?>
                    ...
                    <div class="w-2/5 relative">
                        <select name="tahun" class="select-capsule w-full pl-4 pr-8">
                            <?php $__currentLoopData = range($currentYear-2, $currentYear); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <button type="submit" onclick="tampilkanLoading('<?php echo e($r['title']); ?>', '<?php echo e($r['base']); ?>')" class="btn-generate bg-slate-50 text-slate-600 group-hover:bg-<?php echo e($r['base']); ?>-500 group-hover:text-white group-hover:shadow-[0_10px_20px_rgba(0,0,0,0.15)] mt-2">
...
<?php echo $__env->make('layouts.kader', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POSYANDU\posyandu-management-system\resources\views/kader/laporan/index.blade.php ENDPATH**/ ?>
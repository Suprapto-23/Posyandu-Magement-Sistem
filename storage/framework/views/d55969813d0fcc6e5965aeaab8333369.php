...
<?php $__env->startSection('page-name', 'Pusat Cetak Dokumen'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="report-card bg-white rounded-[28px] p-7 flex flex-col group">
            ...
            <div class="flex items-center gap-4 mb-6">
                <div class="w-14 h-14 rounded-2xl bg-<?php echo e($r['color']); ?>-50 text-<?php echo e($r['color']); ?>-500 flex items-center justify-center text-2xl border border-<?php echo e($r['color']); ?>-100 shrink-0 group-hover:scale-110 transition-transform duration-300">
                    <i class="fas <?php echo e($r['icon']); ?>"></i>
                </div>
                <div>
                    <h3 class="font-black text-slate-800 text-[17px] font-poppins leading-tight tracking-tight"><?php echo e($r['title']); ?></h3>
                    <p class="text-[11px] font-bold text-slate-400 mt-1 uppercase tracking-wider"><?php echo e($r['desc']); ?></p>
                </div>
            </div>

            
            <form action="<?php echo e(route('kader.laporan.generate')); ?>" method="GET" class="mt-auto flex flex-col gap-4">
                ...
                <div class="bg-slate-50 p-1.5 rounded-[16px] border border-slate-200 flex items-center gap-1">
                    <div class="relative w-full">
                        <select name="bulan" class="custom-select w-full bg-white border-none shadow-sm text-slate-700 text-[13px] font-bold rounded-xl pl-4 pr-10 py-3 focus:ring-2 focus:ring-<?php echo e($r['color']); ?>-400 transition-all cursor-pointer">
                    ...
                    <div class="relative w-28 shrink-0">
                        <select name="tahun" class="custom-select w-full bg-white border-none shadow-sm text-slate-700 text-[13px] font-bold rounded-xl pl-4 pr-8 py-3 focus:ring-2 focus:ring-<?php echo e($r['color']); ?>-400 transition-all cursor-pointer">

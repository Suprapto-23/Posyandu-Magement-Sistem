...
<div class="max-w-7xl mx-auto animate-slide-up">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-5 mb-8">
        ...
        <a href="<?php echo e(route('kader.data.balita.create')); ?>" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-indigo-600 text-white font-bold text-[13px] rounded-xl hover:bg-indigo-700 shadow-[0_4px_12px_rgba(79,70,229,0.3)] hover:-translate-y-0.5 transition-all">
    ...
    <div class="bg-white rounded-[24px] border border-slate-200/80 shadow-[0_4px_20px_rgba(0,0,0,0.03)] p-4 mb-6 flex flex-col sm:flex-row gap-4 items-center justify-between">
        <div class="relative w-full sm:w-96 group">
            ...
            <input type="text" id="liveSearch" value="<?php echo e($search); ?>" placeholder="Ketik nama balita, NIK, atau ibu..." 
                ...
                <table class="w-full text-left border-collapse min-w-[850px]">
                    ...
                    <tbody class="divide-y divide-slate-100/80">
                        ...
                        <tr class="hover:bg-indigo-50/30 transition-colors group">
                            ...
                            <td class="px-6 py-5">
                                <div class="flex items-center gap-4">
                                    <div class="w-12 h-12 rounded-2xl flex items-center justify-center font-black text-lg shadow-sm border <?php echo e($balita->jenis_kelamin == 'L' ? 'bg-sky-50 text-sky-500 border-sky-100' : 'bg-rose-50 text-rose-500 border-rose-100'); ?> group-hover:scale-105 transition-transform">
                                        <?php echo e(strtoupper(substr($balita->nama_lengkap, 0, 1))); ?>

                                    </div>
                                    <div>
                                        <p class="font-extrabold text-slate-800 text-[14px] mb-0.5"><?php echo e($balita->nama_lengkap); ?></p>
                                        <p class="text-[11px] font-bold text-slate-400 flex items-center gap-1.5">
                                            <i class="fas fa-barcode"></i> NIK: <?php echo e($balita->nik ?? '-'); ?>
                            ...
                            <td class="px-6 py-5">
                                ...
                                <p class="text-[11px] font-bold text-slate-400 pl-1"><?php echo e(\Carbon\Carbon::parse($balita->tanggal_lahir)->translatedFormat('d M Y')); ?></p>
                            </td>
                            ...
                            <td class="px-6 py-5">
                                ...
                                <p class="text-[11px] font-bold text-slate-400 pl-5">NIK: <?php echo e($balita->nik_ibu); ?></p>
                            </td>
                            ...
                            <td class="px-6 py-5">
                                <div class="flex items-center justify-end gap-2 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
                                    <a href="<?php echo e(route('kader.data.balita.show', $balita->id)); ?>" class="w-9 h-9 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-indigo-600 hover:border-indigo-300 hover:bg-indigo-50 shadow-sm transition-all" title="Lihat Rekam Medis">
                                        <i class="fas fa-stethoscope"></i>
                                    </a>
                                    <a href="<?php echo e(route('kader.data.balita.edit', $balita->id)); ?>" class="w-9 h-9 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-amber-600 hover:border-amber-300 hover:bg-amber-50 shadow-sm transition-all" title="Edit Profil">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <form action="<?php echo e(route('kader.data.balita.destroy', $balita->id)); ?>" method="POST" onsubmit="return confirm('Hapus profil balita ini secara permanen?');" class="inline-block">

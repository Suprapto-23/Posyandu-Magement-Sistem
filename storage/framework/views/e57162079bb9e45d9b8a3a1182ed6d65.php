...
<?php $__env->startSection('page-name', 'Edit Remaja'); ?>
...
<div class="max-w-4xl mx-auto animate-slide-up">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-slate-500 mt-2 font-medium text-sm max-w-lg mx-auto">Memperbarui informasi profil milik <span class="font-bold text-amber-600"><?php echo e($remaja->nama_lengkap); ?></span>.</p>
    </div>
        ...
        <div class="bg-white rounded-[24px] border border-slate-200/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden flex flex-col mb-8">
            ...
            <div class="p-6 sm:p-10 border-b border-slate-100">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap', $remaja->nama_lengkap)); ?>" required class="form-input <?php $__errorArgs = ['nama_lengkap'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="nik" value="<?php echo e(old('nik', $remaja->nik)); ?>" required class="form-input <?php $__errorArgs = ['nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> form-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="tempat_lahir" value="<?php echo e(old('tempat_lahir', $remaja->tempat_lahir)); ?>" required class="form-input <?php $__errorArgs = ['tempat_lahir'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> form-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="<?php echo e(old('tanggal_lahir', $remaja->tanggal_lahir->format('Y-m-d'))); ?>" required class="form-input <?php $__errorArgs = ['tanggal_lahir'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> form-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                ...
                <div class="form-group mb-0">
                    ...
                    <textarea name="alamat" rows="2" required class="form-input resize-none"><?php echo e(old('alamat', $remaja->alamat)); ?></textarea>
                </div>
            </div>
            ...
            <div class="p-6 sm:p-10 bg-amber-50/20">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="sekolah" value="<?php echo e(old('sekolah', $remaja->sekolah)); ?>" class="form-input bg-white">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Kelas</label>
                        <input type="text" name="kelas" value="<?php echo e(old('kelas', $remaja->kelas)); ?>" class="form-input bg-white">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 mb-0">
                    <div class="form-group mb-0 sm:mb-0">
                        ...
                        <input type="text" name="nama_ortu" value="<?php echo e(old('nama_ortu', $remaja->nama_ortu)); ?>" class="form-input bg-white">
                    </div>
                    <div class="form-group mb-0">
                        <label class="form-label">No. HP Orang Tua</label>
                        <input type="number" name="telepon_ortu" value="<?php echo e(old('telepon_ortu', $remaja->telepon_ortu)); ?>" class="form-input bg-white">
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 sm:px-10 sm:py-6 bg-white border-t border-slate-100">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
                    <a href="<?php echo e(route('kader.data.remaja.show', $remaja->id)); ?>" class="w-full py-3.5 bg-slate-100 border border-slate-200 text-slate-600 font-bold text-sm rounded-xl hover:bg-slate-200 hover:text-slate-800 transition-colors flex items-center justify-center gap-2">

    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="txt-center"><?php echo e($row->berat_badan ?? '-'); ?></td>
                <td class="txt-center"><?php echo e($row->tinggi_badan ?? '-'); ?></td>
                <td class="txt-center"><?php echo e($row->lingkar_kepala ?? '-'); ?></td>
                <td class="txt-center txt-bold"><?php echo e(strtoupper($row->status_gizi ?? '-')); ?></td>
                <td style="font-style: italic; font-size: 9pt;"><?php echo e($row->diagnosa ?? '-'); ?></td>
            </tr>
...
</html><?php /**PATH C:\xampp\htdocs\POSYANDU\posyandu-management-system\resources\views/kader/laporan/templates/table-balita.blade.php ENDPATH**/ ?>
...
<div class="max-w-[800px] mx-auto animate-slide-up pb-10">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <a href="<?php echo e(route('bidan.jadwal.index')); ?>" class="smooth-route inline-flex items-center justify-center gap-2 px-6 py-3 bg-white border border-slate-200 text-slate-600 font-bold text-[12px] uppercase tracking-widest rounded-xl hover:bg-slate-50 hover:text-amber-600 transition-colors shadow-sm shrink-0">
    ...
    <div class="bg-white rounded-[32px] border border-slate-200/80 shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden flex flex-col">
        ...
        <form id="formJadwal" action="<?php echo e(route('bidan.jadwal.update', $jadwal->id)); ?>" method="POST" class="flex flex-col flex-1">
            ...
            <div class="p-8 space-y-6 flex-1">
                <div>
                    ...
                    <div class="relative group-focus-within">
                        ...
                        <input type="text" name="judul" value="<?php echo e(old('judul', $jadwal->judul)); ?>" required class="premium-input">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative group-focus-within">
                            ...
                            <input type="date" name="tanggal" value="<?php echo e(old('tanggal', $jadwal->tanggal)); ?>" required class="premium-input cursor-pointer" style="padding-right: 16px;">
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div class="relative group-focus-within">
                                ...
                                <input type="time" name="waktu_mulai" value="<?php echo e(old('waktu_mulai', date('H:i', strtotime($jadwal->waktu_mulai)))); ?>" required class="premium-input cursor-pointer" style="padding-left: 42px; padding-right: 10px;">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative group-focus-within">
                                <i class="far fa-clock input-icon"></i>
                                <input type="time" name="waktu_selesai" value="<?php echo e(old('waktu_selesai', date('H:i', strtotime($jadwal->waktu_selesai)))); ?>" required class="premium-input cursor-pointer" style="padding-left: 42px; padding-right: 10px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative group-focus-within">
                        ...
                        <input type="text" name="lokasi" value="<?php echo e(old('lokasi', $jadwal->lokasi)); ?>" required class="premium-input">
                    </div>
                </div>

...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard Bidan'); ?> - E-Posyandu</title>
        ...
        <div class="main-content" id="mainContent">
            ...
            <header class="top-navbar">
                <div class="page-header">
                    <h4><?php echo $__env->yieldContent('page-title', 'Dashboard Bidan'); ?></h4>
                    <p><?php echo $__env->yieldContent('page-subtitle', 'Portal Tenaga Medis Posyandu'); ?></p>
                </div>
                ...
                <div class="user-menu">
                    ...
                    <div class="dropdown">
                        <button class="user-profile-dropdown dropdown-toggle d-flex align-items-center focus-visible" 
                                ...
                                id="userDropdown">
                            <div class="avatar">
                                <?php echo e(substr(Auth::user()->name ?? 'B', 0, 1)); ?>

                            </div>
                            <div class="user-info d-none d-md-block">
                                <div class="user-name"><?php echo e(Auth::user()->name ?? 'Bidan'); ?></div>

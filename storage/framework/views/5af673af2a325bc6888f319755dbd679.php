...
<?php $__env->startSection('page-name', 'Registrasi Ibu Hamil'); ?>
...
<div class="max-w-4xl mx-auto fade-in">
    ...
    <form action="<?php echo e(route('kader.data.ibu-hamil.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 md:p-8 mb-5">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap')); ?>" required
                       placeholder="Nama sesuai KTP" class="crm-input <?php $__errorArgs = ['nama_lengkap'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> crm-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <div>
                    ...
                    <input type="number" name="nik" value="<?php echo e(old('nik')); ?>" placeholder="16 digit NIK"
                           class="crm-input <?php $__errorArgs = ['nik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> crm-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="telepon_ortu" value="<?php echo e(old('telepon_ortu')); ?>" placeholder="08xx-xxxx-xxxx"
                           class="crm-input">
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <div>
                    ...
                    <input type="text" name="tempat_lahir" value="<?php echo e(old('tempat_lahir')); ?>" placeholder="Kota kelahiran"
                           class="crm-input">
                </div>
                <div>
                    <label class="crm-label">Tanggal Lahir</label>
                    <input type="date" name="tanggal_lahir" value="<?php echo e(old('tanggal_lahir')); ?>" class="crm-input" id="tgl_lahir">
                </div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <div>
                    <label class="crm-label">Nama Suami</label>
                    <input type="text" name="nama_suami" value="<?php echo e(old('nama_suami')); ?>" placeholder="Nama suami"
                           class="crm-input">
                </div>
                <div>
                    ...
                    <select name="golongan_darah" class="crm-input">
                        ...
                        <?php $__currentLoopData = ['A','B','AB','O','A+','A-','B+','B-','AB+','AB-','O+','O-']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($gd); ?>" <?php echo e(old('golongan_darah')==$gd?'selected':''); ?>><?php echo e($gd); ?></option>
            ...
            <div>
                ...
                <textarea name="alamat" rows="2" required placeholder="Alamat lengkap..." class="crm-input resize-none"><?php echo e(old('alamat')); ?></textarea>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 md:p-8 mb-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <div>
                    ...
                    <input type="date" name="hpht" id="hpht" value="<?php echo e(old('hpht')); ?>" class="crm-input">
                </div>
                <div>
                    <label class="crm-label">HPL <span class="text-[10px] text-gray-400">(Hari Perkiraan Lahir)</span></label>
                    <input type="date" name="hpl" id="hpl" value="<?php echo e(old('hpl')); ?>" class="crm-input">
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" name="riwayat_penyakit" value="<?php echo e(old('riwayat_penyakit')); ?>"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" step="0.1" name="berat_badan" id="berat_badan"
                               value="<?php echo e(old('berat_badan')); ?>" placeholder="Contoh: 65" class="crm-input pr-10">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" step="0.1" name="tinggi_badan" id="tinggi_badan"
                               value="<?php echo e(old('tinggi_badan')); ?>" placeholder="Contoh: 158" class="crm-input pr-10">

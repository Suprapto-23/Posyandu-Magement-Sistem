...
<?php $__env->startSection('title', 'Tambah Data Ibu Hamil'); ?>
<?php $__env->startSection('page-name', 'Registrasi Kehamilan'); ?>
...
<div class="max-w-6xl mx-auto animate-slide-up relative z-10 pb-12">
    ...
    <form action="<?php echo e(route('kader.data.ibu-hamil.store')); ?>" method="POST" id="formCreateIbu" class="relative z-10">
        <?php echo csrf_field(); ?>
            ...
            <div class="lg:col-span-7 glass-panel rounded-[32px] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.04)] p-8 md:p-10 relative overflow-hidden flex flex-col">
                ...
                <div class="space-y-6 flex-1">
                    <div>
                        ...
                        <input type="number" name="nik" value="<?php echo e(old('nik')); ?>" required placeholder="16 Digit NIK KTP" class="form-input <?php $__errorArgs = ['nik'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap')); ?>" required placeholder="Contoh: Siti Aisyah" class="form-input <?php $__errorArgs = ['nama_lengkap'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> form-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="tempat_lahir" value="<?php echo e(old('tempat_lahir')); ?>" required placeholder="Kota Kelahiran" class="form-input">
                        </div>
                        <div>
                            <label class="form-label">Tanggal Lahir <span class="text-rose-500">*</span></label>
                            <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="<?php echo e(old('tanggal_lahir')); ?>" required class="form-input cursor-pointer">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="nama_suami" value="<?php echo e(old('nama_suami')); ?>" required placeholder="Nama Lengkap Suami" class="form-input">
                        </div>
                        <div>
                            <label class="form-label">No. HP Keluarga (Opsional)</label>
                            <input type="number" name="telepon_ortu" value="<?php echo e(old('telepon_ortu')); ?>" placeholder="Contoh: 0812xxxx" class="form-input">
                        </div>
                    </div>

                    <div>
                        <label class="form-label">Alamat Domisili <span class="text-rose-500">*</span></label>
                        <textarea name="alamat" rows="2" required placeholder="Alamat lengkap RT/RW..." class="form-input resize-none"><?php echo e(old('alamat')); ?></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-rose-50/80 rounded-[32px] border border-rose-200/80 shadow-[0_10px_40px_-10px_rgba(236,72,153,0.03)] p-8 md:p-10 relative overflow-hidden">
                    ...
                    <div class="space-y-6 relative z-10">
                        <div class="bg-white p-5 rounded-[20px] border border-rose-100 shadow-sm">
                            ...
                            <input type="date" name="hpht" id="hpht" value="<?php echo e(old('hpht')); ?>" required class="form-input bg-slate-50 border-slate-200 focus:bg-white focus:border-rose-400 mb-4 cursor-pointer">
                            
                            <label class="form-label text-rose-600"><i class="fas fa-baby mr-1"></i> HPL (Perkiraan Lahir) <span class="text-rose-500">*</span></label>
                            <input type="date" name="hpl" id="hpl" value="<?php echo e(old('hpl')); ?>" required class="form-input bg-rose-50 border-rose-200 text-rose-800 font-black focus:bg-white focus:border-rose-400" readonly title="Sistem menghitung otomatis dari HPHT">
                        ...
                        <div>
                            ...
                            <select name="golongan_darah" class="form-input bg-white border-rose-100 focus:ring-4 focus:ring-rose-50 cursor-pointer">
                                ...
                                <?php $__currentLoopData = ['A','B','AB','O','A+','A-','B+','B-','AB+','AB-','O+','O-']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($gol); ?>" <?php echo e(old('golongan_darah') == $gol ? 'selected' : ''); ?>><?php echo e($gol); ?></option>
                ...
                <div class="bg-slate-900 rounded-[32px] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.15)] p-8 md:p-10 relative overflow-hidden flex-1 flex flex-col justify-center">
                    ...
                    <div class="grid grid-cols-2 gap-5 mb-5 relative z-10">
                        <div>
                            ...
                            <input type="number" step="0.1" name="berat_badan" id="berat_badan" value="<?php echo e(old('berat_badan')); ?>" placeholder="0.0" class="form-input bg-slate-800 border-slate-700 text-white placeholder:text-slate-600 focus:bg-slate-700 focus:border-pink-500">
                        </div>
                        <div>
                            <label class="form-label text-slate-400">Tinggi (cm)</label>
                            <input type="number" step="0.1" name="tinggi_badan" id="tinggi_badan" value="<?php echo e(old('tinggi_badan')); ?>" placeholder="0.0" class="form-input bg-slate-800 border-slate-700 text-white placeholder:text-slate-600 focus:bg-slate-700 focus:border-pink-500">
                        </div>
                    </div>
...
<script>
    ...
    document.getElementById('hpht').addEventListener('change', function() {
        ...
        hpl.setDate(hpl.getDate() + 280); // Rumus Naegele
    ...
    // Load trigger jika ada old() value
    ...
    document.getElementById('formCreateIbu').addEventListener('submit', function(e) {
        // Optional Frontend Validation tambahan bisa ditaruh disini
...
<?php echo $__env->make('layouts.kader', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POSYANDU\posyandu-management-system\resources\views/kader/data/ibu-hamil/create.blade.php ENDPATH**/ ?>
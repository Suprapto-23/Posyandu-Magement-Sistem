...
<div class="p-4 md:p-8 font-poppins bg-[#f8fafc] min-h-screen space-y-6">
    ...
    <div class="relative bg-gradient-to-r from-emerald-500 to-teal-400 rounded-[2rem] p-8 md:p-10 shadow-[0_10px_30px_-10px_rgba(16,185,129,0.4)] overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div class="relative z-10 shrink-0 hidden md:block">
            <a href="<?php echo e(route('user.balita.index')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-white text-emerald-600 font-bold rounded-xl shadow-lg hover:scale-105 transition-transform">
                <i class="fas fa-baby-carriage"></i> Lihat KMS Anak
            </a>
        </div>
    </div>

    <?php if($totalVaksin > 0): ?>
    <div class="grid grid-cols-2 gap-4">
        <div class="bg-white p-5 md:p-6 rounded-3xl border border-emerald-100 shadow-sm flex items-center gap-4">
            ...
            <div>
                ...
                <h3 class="text-2xl font-black text-slate-800"><?php echo e($totalVaksin); ?> <span class="text-xs text-slate-500 font-medium">Dosis</span></h3>
            </div>
        </div>
        <div class="bg-white p-5 md:p-6 rounded-3xl border border-teal-100 shadow-sm flex items-center gap-4">
            ...
            <div>
                ...
                <h3 class="text-2xl font-black text-slate-800"><?php echo e($anakTerlindungi); ?> <span class="text-xs text-slate-500 font-medium">Anak</span></h3>
            </div>
        </div>
    </div>
    <?php endif; ?>
        ...
        <div class="relative">
                ...
                <div class="mb-6 last:mb-0 relative pl-8 md:pl-12 py-2 group">
                    ...
                    <div class="bg-white border border-slate-200 hover:border-emerald-300 rounded-2xl p-5 transition-all shadow-sm hover:shadow-md flex flex-col lg:flex-row gap-5 lg:items-center relative overflow-hidden">
                        ...
                        <div class="lg:w-1/3 shrink-0 border-b lg:border-b-0 lg:border-r border-slate-100 pb-4 lg:pb-0 lg:pr-6 relative z-10 flex flex-col justify-center">
                            ...
                            <h4 class="text-sm font-black text-slate-800"><?php echo e(\Carbon\Carbon::parse($imun->tanggal_imunisasi)->translatedFormat('l, d F Y')); ?></h4>
                            
                            <div class="mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border <?php echo e($bgColor); ?>">
                                <i class="fas <?php echo e($iconAnak); ?> text-[11px]"></i>
                                <span class="text-[11px] font-bold truncate max-w-[150px]"><?php echo e($namaAnak); ?></span>
                            </div>
                        </div>

                        <div class="flex-1 relative z-10">
                            <h3 class="text-lg md:text-xl font-black text-emerald-600 mb-2"><?php echo e($imun->jenis_imunisasi ?? $imun->nama_vaksin ?? 'Vaksin Imunisasi'); ?></h3>
                            
                            <?php if($imun->keterangan): ?>
                                <div class="bg-slate-50 p-3 rounded-xl border border-slate-100 inline-block w-full">
                                    <p class="text-xs font-medium text-slate-600 leading-relaxed">
                                        <i class="fas fa-quote-left text-slate-300 mr-1"></i> <?php echo e($imun->keterangan); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <div class="py-16 flex flex-col items-center justify-center text-center">
                    ...
                    <a href="<?php echo e(route('user.jadwal.index')); ?>" class="mt-6 text-xs font-bold text-white bg-emerald-500 hover:bg-emerald-600 px-6 py-3 rounded-xl transition-colors shadow-sm">
    ...
    <div class="md:hidden pt-4">
        <a href="<?php echo e(route('user.balita.index')); ?>" class="flex items-center justify-center gap-2 w-full px-6 py-3.5 bg-white border border-slate-200 text-emerald-600 text-sm font-bold rounded-xl shadow-sm">
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\POSYANDU\posyandu-management-system\resources\views/user/balita/imunisasi.blade.php ENDPATH**/ ?>
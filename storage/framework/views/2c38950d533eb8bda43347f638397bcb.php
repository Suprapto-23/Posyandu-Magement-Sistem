            ...
            <table class="w-full text-left border-collapse min-w-[900px]">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors group">
                        <td class="px-6 py-4 text-xs font-bold text-slate-400 align-top"><?php echo e($jadwals->firstItem() + $index); ?></td>
                        
                        <td class="px-6 py-4 align-top">
                            <p class="font-black text-slate-800 text-sm mb-1"><?php echo e(\Carbon\Carbon::parse($jadwal->tanggal)->translatedFormat('d F Y')); ?></p>
                            <p class="text-[11px] font-bold text-cyan-600 bg-cyan-50 inline-block px-2 py-0.5 rounded border border-cyan-100">
                                <i class="fas fa-clock mr-1"></i> <?php echo e(date('H:i', strtotime($jadwal->waktu_mulai))); ?> - <?php echo e(date('H:i', strtotime($jadwal->waktu_selesai))); ?>

                            </p>
                        </td>

                        <td class="px-6 py-4 align-top">
                            <p class="font-bold text-slate-800 text-sm mb-1"><?php echo e($jadwal->judul); ?></p>
                            <p class="text-xs font-semibold text-slate-500 line-clamp-2 mb-1"><?php echo e($jadwal->deskripsi ?? 'Tidak ada deskripsi.'); ?></p>
                            <p class="text-[11px] font-bold text-slate-400"><i class="fas fa-map-marker-alt text-rose-400 mr-1"></i> <?php echo e($jadwal->lokasi); ?></p>
                        </td>
                        ...
                        <td class="px-6 py-4 align-top">
                            <span class="inline-block px-2 py-1 bg-indigo-50 text-indigo-600 text-[10px] font-extrabold rounded border border-indigo-100 uppercase mb-1">
                                Kategori: <?php echo e($jadwal->kategori); ?>
                        ...
                        <td class="px-6 py-4 text-center align-middle">
                            ...
                            ?>
                            <span class="px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider <?php echo e($statusConf[0]); ?>">
                                <?php echo e($statusConf[1]); ?>
                        ...
                        <td class="px-6 py-4 text-right align-middle">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo e(route('bidan.jadwal.edit', $jadwal->id)); ?>" class="smooth-route w-8 h-8 rounded-xl bg-amber-50 text-amber-600 flex items-center justify-center hover:bg-amber-100 transition-colors" title="Edit Jadwal">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="<?php echo e(route('bidan.jadwal.destroy', $jadwal->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus jadwal ini secara permanen?');" class="m-0 p-0">

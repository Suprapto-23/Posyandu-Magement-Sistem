...
<div class="max-w-[1100px] mx-auto fade-in-up pb-20">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 px-2">
        ...
        <a href="<?php echo e(route('bidan.jadwal.index')); ?>" class="inline-flex items-center gap-2 px-6 py-3.5 bg-white border border-slate-200 text-slate-600 font-bold text-[11.5px] uppercase tracking-widest rounded-[16px] hover:bg-slate-50 hover:text-cyan-600 transition-all shadow-sm">
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="judul" value="<?php echo e(old('judul')); ?>" required class="med-input" placeholder="Contoh: Imunisasi Polio Akbar Desa">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="date" name="tanggal" value="<?php echo e(old('tanggal')); ?>" required class="med-input">
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <input type="time" name="waktu_mulai" value="<?php echo e(old('waktu_mulai')); ?>" required class="med-input" style="padding-left: 48px;">
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="input-wrapper">
                                    <i class="far fa-clock input-icon"></i>
                                    <input type="time" name="waktu_selesai" value="<?php echo e(old('waktu_selesai')); ?>" required class="med-input" style="padding-left: 48px;">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" name="lokasi" value="<?php echo e(old('lokasi', 'Posyandu Induk Desa')); ?>" required class="med-input">
                        </div>
                    </div>

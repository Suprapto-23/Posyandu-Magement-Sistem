...
<div class="max-w-[1000px] mx-auto animate-slide-up pb-10">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <a href="<?php echo e(route('bidan.jadwal.index')); ?>" class="smooth-route inline-flex items-center justify-center gap-2 px-6 py-3 bg-white border border-slate-200 text-slate-600 font-bold text-[12px] uppercase tracking-widest rounded-xl hover:bg-slate-50 hover:text-cyan-700 transition-colors shadow-sm shrink-0">
                ...
                <div class="p-8 space-y-6 flex-1">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative group-focus-within">
                                ...
                                <input type="date" name="tanggal" value="<?php echo e(old('tanggal')); ?>" required class="premium-input cursor-pointer" style="padding-right: 16px;">
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="relative group-focus-within">
                                    ...
                                    <input type="time" name="waktu_mulai" value="<?php echo e(old('waktu_mulai')); ?>" required class="premium-input cursor-pointer" style="padding-left: 42px; padding-right: 10px;">
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="relative group-focus-within">
                                    <i class="far fa-clock input-icon"></i>
                                    <input type="time" name="waktu_selesai" value="<?php echo e(old('waktu_selesai')); ?>" required class="premium-input cursor-pointer" style="padding-left: 42px; padding-right: 10px;">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative group-focus-within">
                            ...
                            <textarea name="deskripsi" rows="3" class="premium-input resize-none custom-scrollbar" placeholder="Ketik pesan yang akan muncul di HP warga (Misal: Wajib membawa buku KIA/KMS)"><?php echo e(old('deskripsi')); ?></textarea>
                        </div>
                    </div>
                </div>

...
<?php $__env->startSection('page-name', 'Pendaftaran Remaja'); ?>
...
<div class="max-w-6xl mx-auto animate-slide-up relative z-10 pb-12">
    ...
    <form action="<?php echo e(route('kader.data.remaja.store')); ?>" method="POST" id="formRemaja" class="relative z-10">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_lengkap" value="<?php echo e(old('nama_lengkap')); ?>" required placeholder="Sesuai Kartu Identitas" class="form-input <?php $__errorArgs = ['nama_lengkap'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> form-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="<?php echo e(old('tanggal_lahir')); ?>" required class="form-input cursor-pointer" onchange="calculateAge()">
                ...
                <div class="bg-indigo-50/80 rounded-[32px] border border-indigo-100 shadow-[0_10px_40px_-10px_rgba(79,70,229,0.03)] p-8 md:p-10 relative overflow-hidden">
                    ...
                    <div class="space-y-6 relative z-10">
                        <div class="p-4 bg-white border border-indigo-100 rounded-2xl shadow-sm">
                            ...
                            <input type="text" name="sekolah" value="<?php echo e(old('sekolah')); ?>" placeholder="SMP / SMA N 1..." class="form-input bg-slate-50 focus:bg-white focus:border-indigo-400 mb-4">
                            
                            <label class="form-label text-indigo-600"><i class="fas fa-chalkboard mr-1"></i> Tingkat Kelas</label>
                            <input type="text" name="kelas" value="<?php echo e(old('kelas')); ?>" placeholder="Misal: VIII-A" class="form-input bg-slate-50 focus:bg-white focus:border-indigo-400">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-[32px] border border-slate-200 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.03)] p-8 md:p-10 relative overflow-hidden flex-1 flex flex-col">
                    ...
                    <div class="space-y-6 flex-1">
                        <div>
                            ...
                            <input type="text" name="nama_ortu" value="<?php echo e(old('nama_ortu')); ?>" required placeholder="Nama Ibu atau Ayah" class="form-input">
                        </div>
                        <div>

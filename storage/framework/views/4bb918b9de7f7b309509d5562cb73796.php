...
<div class="p-4 md:p-8 font-poppins bg-[#f8fafc] min-h-screen">
    ...
    <?php if(empty($userAuth->nik) && empty($userAuth->profile->nik)): ?>
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
                ...
                <div class="p-6 md:p-8">
                  <form method="post" action="<?php echo e(route('user.profile.update')); ?>" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <input id="name" name="name" type="text" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all" value="<?php echo e(old('name', $userAuth->profile->full_name ?? $userAuth->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input id="email" name="email" type="email" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all" value="<?php echo e(old('email', $userAuth->email)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input id="tempat_lahir" name="tempat_lahir" type="text" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all" value="<?php echo e(old('tempat_lahir', $userAuth->profile->tempat_lahir ?? '')); ?>">
                            </div>
                            ...
                            <div>
                                ...
                                <input id="tanggal_lahir" name="tanggal_lahir" type="date" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all" value="<?php echo e(old('tanggal_lahir', $userAuth->profile->tanggal_lahir ?? '')); ?>">
                            </div>
                            ...
                            <div>
                                ...
                                <select id="jenis_kelamin" name="jenis_kelamin" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all cursor-pointer">
                                    <option value="L" <?php echo e(old('jenis_kelamin', $userAuth->profile->jenis_kelamin ?? '') == 'L' ? 'selected' : ''); ?>>Laki-laki</option>
                                    <option value="P" <?php echo e(old('jenis_kelamin', $userAuth->profile->jenis_kelamin ?? '') == 'P' ? 'selected' : ''); ?>>Perempuan</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input id="telepon" name="telepon" type="text" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all" value="<?php echo e(old('telepon', $userAuth->profile->telepon ?? '')); ?>" placeholder="Contoh: 08123456789">
                            </div>
                        </div>

                        <div>
                            <label for="alamat" class="block text-[11px] font-black text-slate-500 uppercase tracking-widest mb-2">Alamat Lengkap</label>
                            <textarea id="alamat" name="alamat" rows="2" class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all"><?php echo e(old('alamat', $userAuth->profile->alamat ?? '')); ?></textarea>
                        </div>
        ...
        <div class="lg:col-span-1 space-y-8">
            ...
            <div class="bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
                ...
                <div class="p-6">
                    <form method="post" action="<?php echo e(route('user.password.update')); ?>" class="space-y-5">
                        <?php echo csrf_field(); ?>
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-[10px] text-rose-500 mt-1 font-bold"><?php echo e($message); ?></p> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                        </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-gradient-to-br from-sky-500 to-blue-600 rounded-3xl p-6 text-white shadow-md relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <a href="<?php echo e(route('user.konseling.index')); ?>" class="inline-block px-4 py-2 bg-white text-blue-600 text-[10px] font-bold uppercase tracking-wider rounded-lg shadow-sm hover:bg-slate-50 transition-colors">
                        Hubungi via Chat
                    </a>
                </div>
            </div>
